...
function F(a){var b=a.localName,c="";b?-1<b.indexOf("-")||(c=b,b=a.getAttribute&&a.getAttribute("is")||""):(b=a.is,c=a.extends);return{is:b,u:c}};new Promise(function(a){"complete"===document.readyState?a():document.addEventListener("readystatechange",function(){"complete"===document.readyState&&a()})});function G(){}function H(a,b,c){var e=I;a.__styleScoped?a.__styleScoped=null:Da(e,a,b||"",c)}function Da(a,b,c,e){b.nodeType===Node.ELEMENT_NODE&&Ea(b,c,e);if(b="template"===b.localName?(b.content||b.R).childNodes:b.children||b.childNodes)for(var d=0;d<b.length;d++)Da(a,b[d],c,e)}
function Ea(a,b,c){if(b)if(a.classList)c?(a.classList.remove("style-scope"),a.classList.remove(b)):(a.classList.add("style-scope"),a.classList.add(b));else if(a.getAttribute){var e=a.getAttribute(Fa);c?e&&(b=e.replace("style-scope","").replace(b,""),E(a,b)):E(a,(e?e+" ":"")+"style-scope "+b)}}function J(a,b,c){var e=I,d=a.__cssBuild;t||"shady"===d?b=z(b,c):(a=F(a),b=Ga(e,b,a.is,a.u,c)+"\n\n");return b.trim()}
...
G.prototype.b=function(a,b,c){var e=!1;a=a.trim();var d=M.test(a);d&&(a=a.replace(M,function(a,b,c){return":"+b+"("+c.replace(/\s/g,"")+")"}),a=Ja(a));a=a.replace(Ka,N+" $1");a=a.replace(La,function(a,d,g){e||(a=Ma(g,d,b,c),e=e||a.stop,d=a.H,g=a.value);return d+g});d&&(a=Ja(a));return a};
function Ma(a,b,c,e){var d=a.indexOf(Na);0<=a.indexOf(N)?a=Oa(a,e):0!==d&&(a=c?Pa(a,c):a);c=!1;0<=d&&(b="",c=!0);if(c){var f=!0;c&&(a=a.replace(Qa,function(a,b){return" > "+b}))}a=a.replace(Ra,function(a,b,c){return'[dir="'+c+'"] '+b+", "+b+'[dir="'+c+'"]'});return{value:a,H:b,stop:f}}function Pa(a,b){a=a.split(Sa);a[0]+=b;return a.join(Sa)}
...
function lb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.u;b=a?K(a,b):"html";var f=c.parsedSelector,h=":host > *"===f||"html"===f,g=0===f.indexOf(":host")&&!h;"shady"===e&&(h=f===b+" > *."+b||-1!==f.indexOf("html"),g=!h&&0===f.indexOf(b));"shadow"===e&&(h=":host > *"===f||"html"===f,g=g&&!h);if(h||g)e=b,g&&(c.g||(c.g=L(I,c,I.b,a?Ha+a:"",b)),e=c.g||b),d({M:e,K:g,S:h})}}
function mb(a,b){var c={},e={},d=U,f=b&&b.__cssBuild;A(b,function(b){lb(d,a,b,f,function(d){fb.call(a.A||a,d.M)&&(d.K?S(b,c):S(b,e))})},null,!0);return{L:e,J:c}}
function nb(a,b,c,e){var d=F(b),f=K(d.is,d.u),h=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])");d=Q(b).j;var g=ob(d,e);return J(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=jb(a,b.f.cssText,c));b.cssText=d;if(!t&&!Aa(b)&&b.cssText){var k=d=b.cssText;null==b.C&&(b.C=wa.test(d));if(b.C)if(null==b.w){b.w=[];for(var q in g)k=g[q],k=k(d),d!==k&&(d=k,b.w.push(q))}else{for(q=0;q<b.w.length;++q)k=g[b.w[q]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;q=b.g.split(",");
...
t||H(a.content,b);Y(this);f=y.test(d)||w.test(d);y.lastIndex=0;w.lastIndex=0;d=p(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.v=e;e=[];v||(e=ib(a._styleAst));if(!e.length||v)d=t?a.content:null,b=rb[b],f=J(c,a._styleAst),b=f.length?C(f,c.is,d,b):void 0,a.a=b;a.c=e}};
...
l.getComputedStyleValue=function(a,b){var c;v||(c=(Q(a)||Q(wb(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};l.N=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===I.a){c=e[d+1];break}}}c&&b.push(I.a,c);v||(c=Q(a))&&c.h&&b.push(U.a,c.h);E(a,b.join(" "))};l.G=function(a){return Q(a)};X.prototype.flush=X.prototype.F;
