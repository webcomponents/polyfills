...
function F(a){var b=a.localName,c="";b?-1<b.indexOf("-")||(c=b,b=a.getAttribute&&a.getAttribute("is")||""):(b=a.is,c=a.extends);return{is:b,u:c}}function Aa(a){for(var b=[],c="",e=0;0<=e&&e<a.length;e++)if("("===a[e]){var d=D(a,e);c+=a.slice(e,d+1);e=d}else","===a[e]?(b.push(c),c=""):c+=a[e];c&&b.push(c);return b}function G(a){void 0===a.a&&(a.a=a.getAttribute("css-build"));return a.a||""};function H(){}function Ba(a,b){var c=I;a.__styleScoped?a.__styleScoped=null:J(c,a,function(a){K(a,b||"")})}function J(a,b,c){b.nodeType===Node.ELEMENT_NODE&&c(b);if(b="template"===b.localName?(b.content||b.S||b).childNodes:b.children||b.childNodes)for(var e=0;e<b.length;e++)J(a,b[e],c)}
function K(a,b,c){if(b)if(a.classList)c?(a.classList.remove("style-scope"),a.classList.remove(b)):(a.classList.add("style-scope"),a.classList.add(b));else if(a.getAttribute){var e=a.getAttribute(Ca);c?e&&(b=e.replace("style-scope","").replace(b,""),E(a,b)):E(a,(e?e+" ":"")+"style-scope "+b)}}function Da(a,b,c){var e=I;a.__styleScoped?a.__styleScoped=null:J(e,a,function(a){K(a,b,!0);K(a,c)})}function Ea(a,b){var c=I;a.__styleScoped?a.__styleScoped=null:J(c,a,function(a){K(a,b||"",!0)})}
function L(a,b,c,e){var d=I;q||"shady"===(void 0===e?"":e)?b=y(b,c):(a=F(a),b=Fa(d,b,a.is,a.u,c)+"\n\n");return b.trim()}function Fa(a,b,c,e,d){var f=Ga(c,e);c=c?Ha+c:"";return y(b,function(b){b.c||(b.selector=b.h=Ia(a,b,a.b,c,f),b.c=!0);d&&d(b,c,f)})}function Ga(a,b){return b?"[is="+a+"]":a}function Ia(a,b,c,e,d){var f=Aa(b.selector);if(!wa(b)){b=0;for(var h=f.length,g;b<h&&(g=f[b]);b++)f[b]=c.call(a,g,e,d)}return f.filter(function(a){return!!a}).join(Ja)}
...
x.lastIndex=0,w.lastIndex=0;d=n(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;d=[];v||(d=hb(a._styleAst));if(!d.length||v)f=q?a.content:null,b=U[b]||null,e=L(c,a._styleAst,e),e=e.length?B(e,c.is,f,b):void 0,a.b=e;a.s=d}};l.prepareTemplateDom=function(a,b){q||a.g||(a.g=!0,Ba(a.content,b))};
...
l.D=function(a){var b=this,c=A(a),e=G(a);e!==this.g.v&&(this.g.v=e);z(c,function(a){if(q)ab(a);else{var c=I;a.selector=a.parsedSelector;ab(a);a.selector=a.h=Ia(c,a,c.c,void 0,void 0)}v&&""===e&&(Y(b),b.a&&b.a.transformRule(a))});v?a.textContent=y(c):this.g.l.rules.push(c)};l.getComputedStyleValue=function(a,b){var c;v||(c=(O(a)||O(Hb(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};
l.O=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===I.a){c=e[d+1];break}}}c&&b.push(I.a,c);v||(c=O(a))&&c.i&&b.push(T.a,c.i);E(a,b.join(" "))};l.F=function(a){return O(a)};l.N=function(a,b){K(a,b)};l.R=function(a,b){K(a,b,!0)};l.M=function(a){return ub(a)};l.H=function(a){return tb(a)};X.prototype.flush=X.prototype.flush;X.prototype.prepareTemplate=X.prototype.prepareTemplate;
