...
function lb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.u;b=a?K(a,b):"html";var f=c.parsedSelector,h=":host > *"===f||"html"===f,g=0===f.indexOf(":host")&&!h;"shady"===e&&(h=f===b+" > *."+b||-1!==f.indexOf("html"),g=!h&&0===f.indexOf(b));"shadow"===e&&(h=":host > *"===f||"html"===f,g=g&&!h);if(h||g)e=b,g&&(c.g||(c.g=L(I,c,I.b,a?Ha+a:"",b)),e=c.g||b),d({L:e,J:g,S:h})}}
function mb(a,b){var c={},e={},d=U,f=b&&b.__cssBuild;A(b,function(b){lb(d,a,b,f,function(d){fb.call(a.R||a,d.L)&&(d.J?S(b,c):S(b,e))})},null,!0);return{K:e,I:c}}
function nb(a,b,c,e){var d=F(b),f=K(d.is,d.u),h=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])");d=Q(b).j;var g=ob(d,e);return J(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=jb(a,b.f.cssText,c));b.cssText=d;if(!t&&!Aa(b)&&b.cssText){var k=d=b.cssText;null==b.B&&(b.B=wa.test(d));if(b.B)if(null==b.v){b.v=[];for(var r in g)k=g[r],k=k(d),d!==k&&(d=k,b.v.push(r))}else{for(r=0;r<b.v.length;++r)k=g[b.v[r]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;r=b.g.split(",");
k=0;for(var ub=r.length,O;k<ub&&(O=r[k]);k++)r[k]=O.match(h)?O.replace(f,d):d+" "+O;b.selector=r.join(",")}})}function ob(a,b){a=a.b;var c={};if(!t&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,h=b;f.l=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+h;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=pb(d)}return c}function pb(a){return function(b){return b.replace(a.l,a.a)}}
function qb(a,b){var c=U,e=B(a);a.textContent=z(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(ma,"").replace(na,""),a.cssText=jb(c,d,b))})}aa.Object.defineProperties(hb.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var U=new hb;var rb={},V=window.customElements;if(V&&!t){var sb=V.define;V.define=function(a,b,c){var e=document.createComment(" Shady DOM styles for "+a+" "),d=document.head;d.insertBefore(e,(D?D.nextSibling:null)||d.firstChild);D=e;rb[a]=e;sb.call(V,a,b,c)}};var W=new function(){this.cache={};this.a=100};function X(){this.w={};this.c=document.documentElement;var a=new n;a.rules=[];this.l=eb(this.c,new P(a));this.s=!1;this.b=this.a=null}l=X.prototype;l.D=function(){db()};l.H=function(a){return B(a)};l.N=function(a){return z(a)};l.prepareTemplate=function(a,b,c){this.prepareTemplateDom(a,b);this.prepareTemplateStyles(a,b,c)};
l.prepareTemplateStyles=function(a,b,c){if(!a.s){a.s=!0;a.name=b;a.extends=c;m[b]=a;var e=(e=a.content.querySelector("style"))?e.getAttribute("css-build")||"":"";var d=[];for(var f=a.content.querySelectorAll("style"),h=0;h<f.length;h++){var g=f[h];if(g.hasAttribute("shady-unscoped")){if(!t){var k=g.textContent;za.has(k)||(za.add(k),k=g.cloneNode(!0),document.head.appendChild(k));g.parentNode.removeChild(g)}}else d.push(g.textContent),g.parentNode.removeChild(g)}d=d.join("").trim();c={is:b,extends:c,
O:e};Y(this);f=y.test(d)||w.test(d);y.lastIndex=0;w.lastIndex=0;d=p(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.w=e;e=[];v||(e=ib(a._styleAst));if(!e.length||v)d=t?a.content:null,b=rb[b],f=J(c,a._styleAst),b=f.length?C(f,c.is,d,b):void 0,a.a=b;a.l=e}};l.prepareTemplateDom=function(a,b){t||a.c||(a.c=!0,H(a.content,b))};
...
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued){if(v)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&v&&this.a){var e=B(c);Y(this);this.a.transformRules(e);c.textContent=z(e)}}else for(vb(this,this.c,this.l),b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&qb(c,this.l.m);this.b.enqueued=!1;this.s&&!v&&this.styleDocument()}}};
l.styleElement=function(a,b){var c=F(a).is,e=Q(a);if(!e){var d=F(a);e=d.is;d=d.u;var f=rb[e];e=m[e];if(e){var h=e._styleAst;var g=e.l}e=eb(a,new P(h,f,g,0,d))}a!==this.c&&(this.s=!0);b&&(e.o=e.o||{},Object.assign(e.o,b));if(v){if(e.o){b=e.o;for(var k in b)null===k?a.style.removeProperty(k):a.style.setProperty(k,b[k])}if(((k=m[c])||a===this.c)&&k&&k.a&&!sa(k)){if(sa(k)||k._applyShimValidatingVersion!==k._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(k._styleAst,c),k.a.textContent=J(a,
