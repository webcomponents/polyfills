...
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued&&!H(this.g.cssBuild)){if(u){if(!this.g.cssBuild)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&u&&this.a){var e=A(c);Y(this);this.a.transformRules(e);c.textContent=y(e)}}}else{Bb(this,this.c,this.g);for(b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&ib(c,this.g.l);this.v&&this.styleDocument()}this.b.enqueued=!1}}};
...
f),k._style.textContent=M(a,b.m),yb(k);r&&(f=a.shadowRoot)&&(f=f.querySelector("style"))&&(f.textContent=M(a,b.m));b.m=k._styleAst}}else if(k=c,this.flush(),Bb(this,a,k),k.c&&k.c.length){b=F(a).is;a:{if(f=zb.cache[b])for(g=f.length-1;0<=g;g--){h=f[g];b:{c=k.c;for(e=0;e<c.length;e++)if(d=c[e],h.j[d]!==k.l[d]){c=!1;break b}c=!0}if(c){f=h;break a}}f=void 0}c=f?f.styleElement:null;g=k.i;(h=f&&f.i)||(h=this.A[b]=(this.A[b]||0)+1,h=b+"-"+h);k.i=h;h=k.i;e=T;e=c?c.textContent||"":fb(e,a,k.l,h);d=P(a);var m=
d.a;m&&!r&&m!==c&&(m._useCount--,0>=m._useCount&&m.parentNode&&m.parentNode.removeChild(m));r?d.a?(d.a.textContent=e,c=d.a):e&&(c=B(e,h,a.shadowRoot,d.b)):c?c.parentNode||(Za&&-1<e.indexOf("@media")&&(c.textContent=e),ya(c,null,d.b)):e&&(c=B(e,h,null,d.b));c&&(c._useCount=c._useCount||0,d.a!=c&&c._useCount++,d.a=c);h=c;r||(c=k.i,d=e=a.getAttribute("class")||"",g&&(d=e.replace(new RegExp("\\s*x-scope\\s*"+g+"\\s*","g")," ")),d+=(d?" ":"")+"x-scope "+c,e!==d&&E(a,d));f||zb.store(b,k.l,h,k.i)}};
function Cb(a,b){return(b=b.getRootNode().host)?P(b)?b:Cb(a,b):a.c}function Bb(a,b,c){var e=Cb(a,b),d=P(e),f=d.l;e===a.c||f||(Bb(a,e,d),f=d.l);a=Object.create(f||null);e=eb(b,c.m,c.cssBuild);b=cb(d.m,b).j;Object.assign(a,e.I,b,e.K);b=c.o;for(var g in b)if((d=b[g])||0===d)a[g]=d;g=T;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=S(g,a[e],a);c.l=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
...
l.C=function(a){var b=this,c=G(a);c!==this.g.cssBuild&&(this.g.cssBuild=c);if(!H(c)){var e=A(a);z(e,function(a){if(r)Wa(a);else{var d=K;a.selector=a.parsedSelector;Wa(a);a.selector=a.h=Ha(d,a,d.c,void 0,void 0)}u&&""===c&&(Y(b),b.a&&b.a.transformRule(a))});u?a.textContent=y(e):this.g.m.rules.push(e)}};l.getComputedStyleValue=function(a,b){var c;u||(c=(P(a)||P(Cb(this,a))).l[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};
