...
function jb(a,b,c,e){b.f||Q(b);if(b.f.i){var d=F(a);a=d.is;d=d.u;d=a?L(a,d):"html";var f=b.parsedSelector,g=":host > *"===f||"html"===f,h=0===f.indexOf(":host")&&!g;"shady"===c&&(g=f===d+" > *."+d||-1!==f.indexOf("html"),h=!g&&0===f.indexOf(d));"shadow"===c&&(g=":host > *"===f||"html"===f,h=h&&!g);if(g||h)c=d,h&&(b.g||(b.g=Ha(H,b,H.b,a?Ga+a:"",d)),c=b.g||d),e({B:c,K:h,R:g})}}
function kb(a,b){var c={},e={},d=b&&b.__cssBuild;z(b,function(b){jb(a,b,d,function(d){db.call(a.S||a,d.B)&&(d.K?R(b,c):R(b,e))})},null,!0);return{L:e,J:c}}
...
c={is:b,extends:c,O:e};Y(this);f=w.test(d)||v.test(d);w.lastIndex=0;v.lastIndex=0;d=n(d);f&&u&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.P=e;e=[];u||(e=gb(a._styleAst));if(!e.length||u)d=q?a.content:null,b=U[b]||null,f=K(c,a._styleAst),b=f.length?B(f,c.is,d,b):void 0,a.a=b;a.l=e}};l.prepareTemplateDom=function(a,b){q||a.c||(a.c=!0,Ba(a.content,b))};
...
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued){if(u)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&u&&this.a){var e=A(c);Y(this);this.a.transformRules(e);c.textContent=y(e)}}else for(Gb(this,this.c,this.l),b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&ob(c,this.l.m);this.b.enqueued=!1;this.s&&!u&&this.styleDocument()}}};
...
l.getComputedStyleValue=function(a,b){var c;u||(c=(O(a)||O(Hb(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};l.M=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===H.a){c=e[d+1];break}}}c&&b.push(H.a,c);u||(c=O(a))&&c.h&&b.push(T.a,c.h);E(a,b.join(" "))};l.F=function(a){return O(a)};
l.H=function(a){var b=sb(a),c=a.getRootNode();c&&(b&&c===a.ownerDocument?Ea(a,b):c.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&(c=tb(a),c!==b&&Da(a,b,c)))};X.prototype.flush=X.prototype.flush;X.prototype.prepareTemplate=X.prototype.prepareTemplate;X.prototype.styleElement=X.prototype.styleElement;X.prototype.styleDocument=X.prototype.styleDocument;X.prototype.styleSubtree=X.prototype.styleSubtree;X.prototype.getComputedStyleValue=X.prototype.getComputedStyleValue;X.prototype.setElementClass=X.prototype.M;
X.prototype._styleInfoForNode=X.prototype.F;X.prototype.transformCustomStyleForDocument=X.prototype.D;X.prototype.getStyleAst=X.prototype.I;X.prototype.styleAstToString=X.prototype.N;X.prototype.flushCustomStyles=X.prototype.flushCustomStyles;X.prototype.ensureCorrectScope=X.prototype.H;Object.defineProperties(X.prototype,{nativeShadow:{get:function(){return q}},nativeCss:{get:function(){return u}}});var Z=new X,Ib,Jb;window.ShadyCSS&&(Ib=window.ShadyCSS.ApplyShim,Jb=window.ShadyCSS.CustomStyleInterface);
