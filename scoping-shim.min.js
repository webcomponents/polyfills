...
G.prototype.b=function(a,b,c){var e=!1;a=a.trim();var d=M.test(a);d&&(a=a.replace(M,function(a,b,c){return":"+b+"("+c.replace(/\s/g,"")+")"}),a=Ja(a));a=a.replace(Ka,N+" $1");a=a.replace(La,function(a,d,g){e||(a=Ma(g,d,b,c),e=e||a.stop,d=a.K,g=a.value);return d+g});d&&(a=Ja(a));return a};
function Ma(a,b,c,e){var d=a.indexOf(Na);0<=a.indexOf(N)?a=Oa(a,e):0!==d&&(a=c?Pa(a,c):a);c=!1;0<=d&&(b="",c=!0);if(c){var f=!0;c&&(a=a.replace(Qa,function(a,b){return" > "+b}))}a=a.replace(Ra,function(a,b,c){return'[dir="'+c+'"] '+b+", "+b+'[dir="'+c+'"]'});return{value:a,K:b,stop:f}}function Pa(a,b){a=a.split(Sa);a[0]+=b;return a.join(Sa)}
...
function lb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.s;b=a?K(a,b):"html";var f=c.parsedSelector,h=":host > *"===f||"html"===f,g=0===f.indexOf(":host")&&!h;"shady"===e&&(h=f===b+" > *."+b||-1!==f.indexOf("html"),g=!h&&0===f.indexOf(b));"shadow"===e&&(h=":host > *"===f||"html"===f,g=g&&!h);if(h||g)e=b,g&&(c.g||(c.g=L(I,c,I.b,a?Ha+a:"",b)),e=c.g||b),d({P:e,N:g,W:h})}}
function mb(a,b){var c={},e={},d=U,f=b&&b.__cssBuild;A(b,function(b){lb(d,a,b,f,function(d){fb.call(a.b||a,d.P)&&(d.N?S(b,c):S(b,e))})},null,!0);return{O:e,M:c}}
function nb(a,b,c,e){var d=F(b),f=K(d.is,d.s),h=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])");d=Q(b).j;var g=ob(d,e);return J(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=jb(a,b.f.cssText,c));b.cssText=d;if(!t&&!Aa(b)&&b.cssText){var k=d=b.cssText;null==b.C&&(b.C=wa.test(d));if(b.C)if(null==b.u){b.u=[];for(var r in g)k=g[r],k=k(d),d!==k&&(d=k,b.u.push(r))}else{for(r=0;r<b.u.length;++r)k=g[b.u[r]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;r=b.g.split(",");
k=0;for(var ub=r.length,O;k<ub&&(O=r[k]);k++)r[k]=O.match(h)?O.replace(f,d):d+" "+O;b.selector=r.join(",")}})}function ob(a,b){a=a.b;var c={};if(!t&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,h=b;f.o=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+h;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=pb(d)}return c}function pb(a){return function(b){return b.replace(a.o,a.a)}}
function qb(a,b){var c=U,e=B(a);a.textContent=z(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(ma,"").replace(na,""),a.cssText=jb(c,d,b))})}aa.Object.defineProperties(hb.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var U=new hb;var rb={},V=window.customElements;if(V&&!t){var sb=V.define;V.define=function(a,b,c){var e=document.createComment(" Shady DOM styles for "+a+" "),d=document.head;d.insertBefore(e,(D?D.nextSibling:null)||d.firstChild);D=e;rb[a]=e;sb.call(V,a,b,c)}};var W=new function(){this.cache={};this.a=100};function X(){this.B={};this.c=document.documentElement;var a=new n;a.rules=[];this.o=eb(this.c,new P(a));this.v=!1;this.b=this.a=null}l=X.prototype;l.F=function(){db()};l.L=function(a){return B(a)};l.S=function(a){return z(a)};l.prepareTemplate=function(a,b,c){this.prepareTemplateDom(a,b);this.prepareTemplateStyles(a,b,c)};
l.prepareTemplateStyles=function(a,b,c){if(!a.I){a.I=!0;a.name=b;a.extends=c;m[b]=a;var e=(e=a.content.querySelector("style"))?e.getAttribute("css-build")||"":"";var d=[];for(var f=a.content.querySelectorAll("style"),h=0;h<f.length;h++){var g=f[h];if(g.hasAttribute("shady-unscoped")){if(!t){var k=g.textContent;za.has(k)||(za.add(k),k=g.cloneNode(!0),document.head.appendChild(k));g.parentNode.removeChild(g)}}else d.push(g.textContent),g.parentNode.removeChild(g)}d=d.join("").trim();c={is:b,extends:c,
T:e};Y(this);f=y.test(d)||w.test(d);y.lastIndex=0;w.lastIndex=0;d=p(d);f&&v&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.V=e;e=[];v||(e=ib(a._styleAst));if(!e.length||v)d=t?a.content:null,b=rb[b],f=J(c,a._styleAst),b=f.length?C(f,c.is,d,b):void 0,a.A=b;a.H=e}};l.prepareTemplateDom=function(a,b){t||a.G||(a.G=!0,H(a.content,b))};
...
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued){if(v)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&v&&this.a){var e=B(c);Y(this);this.a.transformRules(e);c.textContent=z(e)}}else for(vb(this,this.c,this.o),b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&qb(c,this.o.l);this.b.enqueued=!1;this.v&&!v&&this.styleDocument()}}};
l.styleElement=function(a,b){var c=F(a).is,e=Q(a);if(!e){var d=F(a);e=d.is;d=d.s;var f=rb[e];e=m[e];if(e){var h=e._styleAst;var g=e.H}e=eb(a,new P(h,f,g,0,d))}a!==this.c&&(this.v=!0);b&&(e.m=e.m||{},Object.assign(e.m,b));if(v){if(e.m){b=e.m;for(var k in b)null===k?a.style.removeProperty(k):a.style.setProperty(k,b[k])}if(((k=m[c])||a===this.c)&&k&&k.A&&!sa(k)){if(sa(k)||k._applyShimValidatingVersion!==k._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(k._styleAst,c),k.A.textContent=J(a,
e.j),ta(k);t&&(c=a.shadowRoot)&&(c.querySelector("style").textContent=J(a,e.j));e.j=k._styleAst}}else if(vb(this,a,e),e.w&&e.w.length){c=e;k=F(a).is;a:{if(b=W.cache[k])for(h=b.length-1;0<=h;h--){g=b[h];b:{e=c.w;for(d=0;d<e.length;d++)if(f=e[d],g.i[f]!==c.l[f]){e=!1;break b}e=!0}if(e){b=g;break a}}b=void 0}e=b?b.styleElement:null;h=c.h;(g=b&&b.h)||(g=this.B[k]=(this.B[k]||0)+1,g=k+"-"+g);c.h=g;g=c.h;d=U;d=e?e.textContent||"":nb(d,a,c.l,g);f=Q(a);var x=f.a;x&&!t&&x!==e&&(x._useCount--,0>=x._useCount&&
x.parentNode&&x.parentNode.removeChild(x));t?f.a?(f.a.textContent=d,e=f.a):d&&(e=C(d,g,a.shadowRoot,f.b)):e?e.parentNode||(gb&&-1<d.indexOf("@media")&&(e.textContent=d),Ba(e,null,f.b)):d&&(e=C(d,g,null,f.b));e&&(e._useCount=e._useCount||0,f.a!=e&&e._useCount++,f.a=e);g=e;t||(e=c.h,f=d=a.getAttribute("class")||"",h&&(f=d.replace(new RegExp("\\s*x-scope\\s*"+h+"\\s*","g")," ")),f+=(f?" ":"")+"x-scope "+e,d!==f&&E(a,f));b||(a=W.cache[k]||[],a.push({i:c.l,styleElement:g,h:c.h}),a.length>W.a&&a.shift(),
W.cache[k]=a)}};function wb(a,b){return(b=b.getRootNode().host)?Q(b)?b:wb(a,b):a.c}function vb(a,b,c){a=wb(a,b);var e=Q(a);a=Object.create(e.l||null);var d=mb(b,c.j);b=kb(e.j,b).i;Object.assign(a,d.M,b,d.O);b=c.m;for(var f in b)if((d=b[f])||0===d)a[f]=d;f=U;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=T(f,a[e],a);c.l=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=B(a);A(c,function(a){if(t)Wa(a);else{var c=I;a.selector=a.parsedSelector;Wa(a);a.selector=a.g=L(c,a,c.c,void 0,void 0)}v&&(Y(b),b.a&&b.a.transformRule(a))});v?a.textContent=z(c):this.o.j.rules.push(c)};
l.getComputedStyleValue=function(a,b){var c;v||(c=(Q(a)||Q(wb(this,a))).l[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};l.R=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===I.a){c=e[d+1];break}}}c&&b.push(I.a,c);v||(c=Q(a))&&c.h&&b.push(U.a,c.h);E(a,b.join(" "))};l.J=function(a){return Q(a)};X.prototype.flush=X.prototype.F;
X.prototype.prepareTemplate=X.prototype.prepareTemplate;X.prototype.styleElement=X.prototype.styleElement;X.prototype.styleDocument=X.prototype.styleDocument;X.prototype.styleSubtree=X.prototype.styleSubtree;X.prototype.getComputedStyleValue=X.prototype.getComputedStyleValue;X.prototype.setElementClass=X.prototype.R;X.prototype._styleInfoForNode=X.prototype.J;X.prototype.transformCustomStyleForDocument=X.prototype.D;X.prototype.getStyleAst=X.prototype.L;X.prototype.styleAstToString=X.prototype.S;
...
getComputedStyleValue:function(a,b){return Z.getComputedStyleValue(a,b)},nativeCss:v,nativeShadow:t};xb&&(window.ShadyCSS.ApplyShim=xb);yb&&(window.ShadyCSS.CustomStyleInterface=yb);}).call(this);
