...
function K(a,b,c){var e=H,d=a.__cssBuild;q||"shady"===d?b=x(b,c):(a=F(a),b=Fa(e,b,a.is,a.u,c)+"\n\n");return b.trim()}function Fa(a,b,c,e,d){var f=L(c,e);c=c?Ga+c:"";return x(b,function(b){b.c||(b.selector=b.g=Ha(a,b,a.b,c,f),b.c=!0);d&&d(b,c,f)})}function L(a,b){return b?"[is="+a+"]":a}function Ha(a,b,c,e,d){var f=Aa(b.selector);if(!wa(b)){b=0;for(var g=f.length,h;b<g&&(h=f[b]);b++)f[b]=c.call(a,h,e,d)}return f.filter(function(a){return!!a}).join(Ia)}
...
function jb(a,b,c,e){b.f||Q(b);if(b.f.i){var d=F(a);a=d.is;d=d.u;d=a?L(a,d):"html";var f=b.parsedSelector,g=":host > *"===f||"html"===f,h=0===f.indexOf(":host")&&!g;"shady"===c&&(g=f===d+" > *."+d||-1!==f.indexOf("html"),h=!g&&0===f.indexOf(d));"shadow"===c&&(g=":host > *"===f||"html"===f,h=h&&!g);if(g||h)c=d,h&&(b.g||(b.g=Ha(H,b,H.b,a?Ga+a:"",d)),c=b.g||d),e({B:c,K:h,U:g})}}
function kb(a,b){var c={},e={},d=b&&b.__cssBuild;z(b,function(b){jb(a,b,d,function(d){db.call(a.V||a,d.B)&&(d.K?R(b,c):R(b,e))})},null,!0);return{L:e,J:c}}
...
k=0;for(var Bb=t.length,P;k<Bb&&(P=t[k]);k++)t[k]=P.match(g)?P.replace(f,d):d+" "+P;b.selector=t.join(",")}})}function mb(a,b){a=a.b;var c={};if(!q&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,g=b;f.l=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+g;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=nb(d)}return c}function nb(a){return function(b){return b.replace(a.l,a.a)}}
function ob(a,b){var c=T,e=A(a);a.textContent=x(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(ma,"").replace(na,""),a.cssText=hb(c,d,b))})}aa.Object.defineProperties(fb.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var T=new fb;var U={},V=window.customElements;if(V&&!q){var pb=V.define;V.define=function(a,b,c){U[a]||(U[a]=ya(a));pb.call(V,a,b,c)}};function qb(){this.cache={}}qb.prototype.store=function(a,b,c,e){var d=this.cache[a]||[];d.push({i:b,styleElement:c,h:e});100<d.length&&d.shift();this.cache[a]=d};function rb(){}function sb(a){var b=[];a.classList?b=Array.from(a.classList):a instanceof window.SVGElement&&a.hasAttribute("class")&&(b=a.getAttribute("class").split(/\s+/));a=b;b=a.indexOf(H.a);return-1<b?a[b+1]:""}function tb(a){var b=a.getRootNode();return b===a||b===a.ownerDocument?"":(a=b.host)?F(a).is:""}
function ub(a){for(var b=0;b<a.length;b++){var c=a[b];if(c.target!==document.documentElement&&c.target!==document.head)for(var e=0;e<c.addedNodes.length;e++){var d=c.addedNodes[e];if(d.nodeType===Node.ELEMENT_NODE){var f=d.getRootNode(),g=sb(d);if(g&&f===d.ownerDocument)Ea(d,g);else if(f instanceof ShadowRoot)for(f=tb(d),f!==g&&Da(d,g,f),d=window.ShadyDOM.nativeMethods.querySelectorAll.call(d,":not(."+H.a+")"),g=0;g<d.length;g++){f=d[g];var h=tb(f);h&&J(f,h)}}}}}
if(!(q||window.ShadyDOM&&window.ShadyDOM.handlesDynamicScoping)){var vb=new MutationObserver(ub),wb=function(a){vb.observe(a,{childList:!0,subtree:!0})};if(window.customElements&&!window.customElements.polyfillWrapFlushCallback)wb(document);else{var xb=function(){wb(document.body)};window.HTMLImports?window.HTMLImports.whenReady(xb):requestAnimationFrame(function(){if("loading"===document.readyState){var a=function(){xb();document.removeEventListener("readystatechange",a)};document.addEventListener("readystatechange",
a)}else xb()})}rb=function(){ub(vb.takeRecords())}}var yb=rb;var W={};var zb=Promise.resolve();function Ab(a){if(a=W[a])a._applyShimCurrentVersion=a._applyShimCurrentVersion||0,a._applyShimValidatingVersion=a._applyShimValidatingVersion||0,a._applyShimNextVersion=(a._applyShimNextVersion||0)+1}function Cb(a){return a._applyShimCurrentVersion===a._applyShimNextVersion}function Db(a){a._applyShimValidatingVersion=a._applyShimNextVersion;a.b||(a.b=!0,zb.then(function(){a._applyShimCurrentVersion=a._applyShimNextVersion;a.b=!1}))};var Eb=new qb;function X(){this.w={};this.c=document.documentElement;var a=new m;a.rules=[];this.l=cb(this.c,new N(a));this.s=!1;this.b=this.a=null}l=X.prototype;l.flush=function(){yb()};l.I=function(a){return A(a)};l.P=function(a){return x(a)};l.prepareTemplate=function(a,b,c){this.prepareTemplateDom(a,b);this.prepareTemplateStyles(a,b,c)};
...
c={is:b,extends:c,S:e};Y(this);f=w.test(d)||v.test(d);w.lastIndex=0;v.lastIndex=0;d=n(d);f&&u&&this.a&&this.a.transformRules(d,b);a._styleAst=d;a.T=e;e=[];u||(e=gb(a._styleAst));if(!e.length||u)d=q?a.content:null,b=U[b]||null,f=K(c,a._styleAst),b=f.length?B(f,c.is,d,b):void 0,a.a=b;a.l=e}};l.prepareTemplateDom=function(a,b){q||a.c||(a.c=!0,Ba(a.content,b))};
...
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued){if(u)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&u&&this.a){var e=A(c);Y(this);this.a.transformRules(e);c.textContent=x(e)}}else for(Gb(this,this.c,this.l),b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&ob(c,this.l.m);this.b.enqueued=!1;this.s&&!u&&this.styleDocument()}}};
l.styleElement=function(a,b){var c=F(a).is,e=O(a);if(!e){var d=F(a);e=d.is;d=d.u;var f=U[e]||null;e=W[e];if(e){var g=e._styleAst;var h=e.l}g=new N(g,f,h,d);e&&cb(a,g);e=g}a!==this.c&&(this.s=!0);b&&(e.o=e.o||{},Object.assign(e.o,b));if(u){if(e.o){b=e.o;for(var k in b)null===k?a.style.removeProperty(k):a.style.setProperty(k,b[k])}if(((k=W[c])||a===this.c)&&k&&k.a&&!Cb(k)){if(Cb(k)||k._applyShimValidatingVersion!==k._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(k._styleAst,c),k.a.textContent=
K(a,e.j),Db(k);q&&(c=a.shadowRoot)&&(c.querySelector("style").textContent=K(a,e.j));e.j=k._styleAst}}else if(this.flush(),Gb(this,a,e),e.A&&e.A.length){c=e;k=F(a).is;a:{if(b=Eb.cache[k])for(g=b.length-1;0<=g;g--){h=b[g];b:{e=c.A;for(d=0;d<e.length;d++)if(f=e[d],h.i[f]!==c.m[f]){e=!1;break b}e=!0}if(e){b=h;break a}}b=void 0}e=b?b.styleElement:null;g=c.h;(h=b&&b.h)||(h=this.w[k]=(this.w[k]||0)+1,h=k+"-"+h);c.h=h;h=c.h;d=T;d=e?e.textContent||"":lb(d,a,c.m,h);f=O(a);var y=f.a;y&&!q&&y!==e&&(y._useCount--,
0>=y._useCount&&y.parentNode&&y.parentNode.removeChild(y));q?f.a?(f.a.textContent=d,e=f.a):d&&(e=B(d,h,a.shadowRoot,f.b)):e?e.parentNode||(eb&&-1<d.indexOf("@media")&&(e.textContent=d),xa(e,null,f.b)):d&&(e=B(d,h,null,f.b));e&&(e._useCount=e._useCount||0,f.a!=e&&e._useCount++,f.a=e);h=e;q||(e=c.h,f=d=a.getAttribute("class")||"",g&&(f=d.replace(new RegExp("\\s*x-scope\\s*"+g+"\\s*","g")," ")),f+=(f?" ":"")+"x-scope "+e,d!==f&&E(a,f));b||Eb.store(k,c.m,h,c.h)}};
function Hb(a,b){return(b=b.getRootNode().host)?O(b)?b:Hb(a,b):a.c}function Gb(a,b,c){a=Hb(a,b);var e=O(a);a=Object.create(e.m||null);var d=kb(b,c.j);b=ib(e.j,b).i;Object.assign(a,d.J,b,d.L);b=c.o;for(var f in b)if((d=b[f])||0===d)a[f]=d;f=T;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=S(f,a[e],a);c.m=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=A(a);z(c,function(a){if(q)$a(a);else{var c=H;a.selector=a.parsedSelector;$a(a);a.selector=a.g=Ha(c,a,c.c,void 0,void 0)}u&&(Y(b),b.a&&b.a.transformRule(a))});u?a.textContent=x(c):this.l.j.rules.push(c)};
l.getComputedStyleValue=function(a,b){var c;u||(c=(O(a)||O(Hb(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};l.O=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===H.a){c=e[d+1];break}}}c&&b.push(H.a,c);u||(c=O(a))&&c.h&&b.push(T.a,c.h);E(a,b.join(" "))};l.F=function(a){return O(a)};l.N=function(a,b){J(a,b)};
l.R=function(a,b){J(a,b,!0)};l.M=function(a){return tb(a)};l.H=function(a){return sb(a)};X.prototype.flush=X.prototype.flush;X.prototype.prepareTemplate=X.prototype.prepareTemplate;X.prototype.styleElement=X.prototype.styleElement;X.prototype.styleDocument=X.prototype.styleDocument;X.prototype.styleSubtree=X.prototype.styleSubtree;X.prototype.getComputedStyleValue=X.prototype.getComputedStyleValue;X.prototype.setElementClass=X.prototype.O;X.prototype._styleInfoForNode=X.prototype.F;
X.prototype.transformCustomStyleForDocument=X.prototype.D;X.prototype.getStyleAst=X.prototype.I;X.prototype.styleAstToString=X.prototype.P;X.prototype.flushCustomStyles=X.prototype.flushCustomStyles;X.prototype.scopeNode=X.prototype.N;X.prototype.unscopeNode=X.prototype.R;X.prototype.scopeForNode=X.prototype.M;X.prototype.currentScopeForNode=X.prototype.H;Object.defineProperties(X.prototype,{nativeShadow:{get:function(){return q}},nativeCss:{get:function(){return u}}});var Z=new X,Ib,Jb;window.ShadyCSS&&(Ib=window.ShadyCSS.ApplyShim,Jb=window.ShadyCSS.CustomStyleInterface);
window.ShadyCSS={ScopingShim:Z,prepareTemplate:function(a,b,c){Z.flushCustomStyles();Z.prepareTemplate(a,b,c)},prepareTemplateDom:function(a,b){Z.prepareTemplateDom(a,b)},prepareTemplateStyles:function(a,b,c){Z.flushCustomStyles();Z.prepareTemplateStyles(a,b,c)},styleSubtree:function(a,b){Z.flushCustomStyles();Z.styleSubtree(a,b)},styleElement:function(a){Z.flushCustomStyles();Z.styleElement(a)},styleDocument:function(a){Z.flushCustomStyles();Z.styleDocument(a)},flushCustomStyles:function(){Z.flushCustomStyles()},
getComputedStyleValue:function(a,b){return Z.getComputedStyleValue(a,b)},nativeCss:u,nativeShadow:q};Ib&&(window.ShadyCSS.ApplyShim=Ib);Jb&&(window.ShadyCSS.CustomStyleInterface=Jb);}).call(this);
