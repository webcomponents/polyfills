...
function(){db();document.removeEventListener("readystatechange",a)};document.addEventListener("readystatechange",a)}else db()})}$a=function(){ab(bb.takeRecords())}}var eb=$a;function O(a,b,c,e,d){this.j=a||null;this.b=b||null;this.B=c||[];this.s=null;this.v=d||"";this.a=this.h=this.m=null}function P(a){return a?a.__styleInfo:null}function fb(a,b){return a.__styleInfo=b}O.prototype.c=function(){return this.j};O.prototype._getStyleRules=O.prototype.c;var Q=window.Element.prototype,gb=Q.matches||Q.matchesSelector||Q.mozMatchesSelector||Q.msMatchesSelector||Q.oMatchesSelector||Q.webkitMatchesSelector,hb=navigator.userAgent.match("Trident");function ib(){}function jb(a){var b={},c=[],e=0;z(a,function(a){R(a);a.index=e++;a=a.f.cssText;for(var c;c=ua.exec(a);){var d=c[1];":"!==c[2]&&(b[d]=!0)}},function(a){c.push(a)});a.b=c;a=[];for(var d in b)a.push(d);return a}
...
function mb(a,b,c,e,d){c.f||R(c);if(c.f.i){var f=E(b);a=f.is;f=f.v;b=b.is?L(a,f):"html";var g=c.parsedSelector,f=":host > *"===g||"html"===g,h=0===g.indexOf(":host")&&!f;"shady"===e&&(f=g===b+" > *."+b||-1!==g.indexOf("html"),h=!f&&0===g.indexOf(b));"shadow"===e&&(f=":host > *"===g||"html"===g,h=h&&!f);if(f||h)e=b,h&&(v&&!c.g&&(c.g=N(J,c,J.b,a?Ha+a:"",b)),e=c.g||b),d({M:e,K:h,T:f})}}
function nb(a,b){var c={},e={},d=U,f=b&&b.__cssBuild;z(b,function(b){mb(d,a,b,f,function(d){gb.call(a.S||a,d.M)&&(d.K?S(b,c):S(b,e))})},null,!0);return{L:e,J:c}}
function ob(a,b,c,e){var d=E(b),f=L(d.is,d.v),g=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])"),d=P(b).j,h=pb(d,e);return K(b,d,function(b){var d="";b.f||R(b);b.f.cssText&&(d=kb(a,b.f.cssText,c));b.cssText=d;if(!v&&!za(b)&&b.cssText){var k=d=b.cssText;null==b.C&&(b.C=va.test(d));if(b.C)if(null==b.w){b.w=[];for(var q in h)k=h[q],k=k(d),d!==k&&(d=k,b.w.push(q))}else{for(q=0;q<b.w.length;++q)k=h[b.w[q]],d=k(d);k=d}b.cssText=k;b.g=b.g||b.selector;d="."+e;q=b.g.split(",");
...
function rb(a,b){var c=U,e=A(a);a.textContent=y(e,function(a){var d=a.cssText=a.parsedCssText;a.f&&a.f.cssText&&(d=d.replace(la,"").replace(ma,""),a.cssText=kb(c,d,b))})}aa.Object.defineProperties(ib.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"x-scope"}}});var U=new ib;var sb={},V=window.customElements;if(V&&!v){var tb=V.define;V.define=function(a,b,c){var e=document.createComment(" Shady DOM styles for "+a+" "),d=document.head;d.insertBefore(e,(C?C.nextSibling:null)||d.firstChild);C=e;sb[a]=e;return tb.call(V,a,b,c)}};var W=new function(){this.cache={};this.a=100};function X(){var a=this;this.A={};this.c=document.documentElement;var b=new n;b.rules=[];this.l=fb(this.c,new O(b));this.u=!1;this.a=this.b=null;Da(function(){Y(a)})}l=X.prototype;l.F=function(){eb()};l.I=function(a){return A(a)};l.O=function(a){return y(a)};
l.prepareTemplate=function(a,b,c){if(!a.u){a.u=!0;a.name=b;a.extends=c;m[b]=a;var e;e=(e=a.content.querySelector("style"))?e.getAttribute("css-build")||"":"";var d;d=a.content.querySelectorAll("style");for(var f=[],g=0;g<d.length;g++){var h=d[g];f.push(h.textContent);h.parentNode.removeChild(h)}d=f.join("").trim();c={is:b,extends:c,P:e};v||I(a.content,b);Y(this);f=this.b.detectMixin(d);d=p(d);f&&x&&this.b.transformRules(d,b);a.a=d;a.A=e;e=[];x||(e=jb(a.a));if(!e.length||x)d=v?a.content:null,b=sb[b],
f=K(c,a.a),b=f.length?B(f,c.is,d,b):void 0,a.c=b;a.l=e}};function ub(a){if(!a.b)if(window.ShadyCSS.ApplyShim)a.b=window.ShadyCSS.ApplyShim,a.b.invalidCallback=qa;else{var b={};a.b=(b.detectMixin=function(){return!1},b.transformRule=function(){},b.transformRules=function(){},b)}}
function wb(a){if(!a.a)if(window.ShadyCSS.CustomStyleInterface)a.a=window.ShadyCSS.CustomStyleInterface,a.a.transformCallback=function(b){a.D(b)},a.a.validateCallback=function(){requestAnimationFrame(function(){(a.a.enqueued||a.u)&&a.o()})};else{var b={};a.a=(b.processStyles=function(){},b.enqueued=!1,b.getStyleForCustomStyle=function(){return null},b)}}function Y(a){ub(a);wb(a)}
l.o=function(){Y(this);var a=this.a.processStyles();if(this.a.enqueued){if(x)for(var b=0;b<a.length;b++){var c=this.a.getStyleForCustomStyle(a[b]);if(c&&x){var e=A(c);Y(this);this.b.transformRules(e);c.textContent=y(e)}}else for(xb(this,this.c,this.l),b=0;b<a.length;b++)(c=this.a.getStyleForCustomStyle(a[b]))&&rb(c,this.l.m);this.a.enqueued=!1;this.u&&!x&&this.styleDocument()}};
l.styleElement=function(a,b){var c=E(a).is,e=P(a);if(!e){var d=E(a),e=d.is,d=d.v,f=sb[e],e=m[e],g,h;e&&(g=e.a,h=e.l);e=fb(a,new O(g,f,h,0,d))}a!==this.c&&(this.u=!0);b&&(e.s=e.s||{},Object.assign(e.s,b));if(x){if(e.s){b=e.s;for(var k in b)null===k?a.style.removeProperty(k):a.style.setProperty(k,b[k])}((k=m[c])||a===this.c)&&k&&k.c&&k._applyShimInvalid&&(k.b||(Y(this),this.b.transformRules(k.a,c),k.c.textContent=K(a,e.j),ra(k)),v&&(c=a.shadowRoot)&&(c.querySelector("style").textContent=K(a,e.j)),e.j=
k.a)}else if(xb(this,a,e),e.B&&e.B.length){c=e;k=E(a).is;a:{if(b=W.cache[k])for(g=b.length-1;0<=g;g--){h=b[g];b:{e=c.B;for(d=0;d<e.length;d++)if(f=e[d],h.i[f]!==c.m[f]){e=!1;break b}e=!0}if(e){b=h;break a}}b=void 0}e=b?b.styleElement:null;g=c.h;(h=b&&b.h)||(h=this.A[k]=(this.A[k]||0)+1,h=k+"-"+h);c.h=h;h=c.h;var d=U,d=e?e.textContent||"":ob(d,a,c.m,h),f=P(a),w=f.a;w&&!v&&w!==e&&(w._useCount--,0>=w._useCount&&w.parentNode&&w.parentNode.removeChild(w));v?f.a?(f.a.textContent=d,e=f.a):d&&(e=B(d,h,a.shadowRoot,
f.b)):e?e.parentNode||Aa(e,null,f.b):d&&(e=B(d,h,null,f.b));e&&(e._useCount=e._useCount||0,f.a!=e&&e._useCount++,f.a=e);hb&&(e.textContent=e.textContent);h=e;v||(e=c.h,f=d=a.getAttribute("class")||"",g&&(f=d.replace(new RegExp("\\s*x-scope\\s*"+g+"\\s*","g")," ")),f+=(f?" ":"")+"x-scope "+e,d!==f&&D(a,f));b||(a=W.cache[k]||[],a.push({i:c.m,styleElement:h,h:c.h}),a.length>W.a&&a.shift(),W.cache[k]=a)}};function yb(a,b){return(b=b.getRootNode().host)?P(b)?b:yb(a,b):a.c}
function xb(a,b,c){a=yb(a,b);var e=P(a);a=Object.create(e.m||null);var d=nb(b,c.j);b=lb(e.j,b).i;Object.assign(a,d.J,b,d.L);b=c.s;for(var f in b)if((d=b[f])||0===d)a[f]=d;f=U;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=T(f,a[e],a);c.m=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=A(a);z(c,function(a){if(v)Xa(a);else{var c=J;a.selector=a.parsedSelector;Xa(a);a.selector=a.g=N(c,a,c.c,void 0,void 0)}x&&(Y(b),b.b.transformRule(a))});x?a.textContent=y(c):this.l.j.rules.push(c)};
l.getComputedStyleValue=function(a,b){var c;x||(c=(P(a)||P(yb(this,a))).m[b]);c=c||window.getComputedStyle(a).getPropertyValue(b);return c.trim()};l.N=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e)for(var e=e.split(/\s/),d=0;d<e.length;d++)if(e[d]===J.a){c=e[d+1];break}}c&&b.push(J.a,c);x||(c=P(a))&&c.h&&b.push(U.a,c.h);D(a,b.join(" "))};l.G=function(a){return P(a)};X.prototype.flush=X.prototype.F;
