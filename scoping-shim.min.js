...
function F(a){var b=a.localName,c="";b?-1<b.indexOf("-")||(c=b,b=a.getAttribute&&a.getAttribute("is")||""):(b=a.is,c=a.extends);return{is:b,u:c}};function G(){}function H(a,b,c){var e=I;a.__styleScoped?a.__styleScoped=null:Da(e,a,b||"",c)}function Da(a,b,c,e){b.nodeType===Node.ELEMENT_NODE&&Ea(b,c,e);if(b="template"===b.localName?(b.content||b.R).childNodes:b.children||b.childNodes)for(var d=0;d<b.length;d++)Da(a,b[d],c,e)}
