...
function mb(a,b,c,e,d){c.f||R(c);if(c.f.i){var f=E(b);a=f.is;f=f.u;b=b.is?L(a,f):"html";var g=c.parsedSelector,f=":host > *"===g||"html"===g,h=0===g.indexOf(":host")&&!f;"shady"===e&&(f=g===b+" > *."+b||-1!==g.indexOf("html"),h=!f&&0===g.indexOf(b));"shadow"===e&&(f=":host > *"===g||"html"===g,h=h&&!f);if(f||h)e=b,h&&(v&&!c.g&&(c.g=N(J,c,J.b,a?Ha+a:"",b)),e=c.g||b),d({M:e,K:h,S:f})}}
