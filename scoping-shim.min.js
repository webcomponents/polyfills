...
function gb(a,b,c,e){var d=G(b),f=Ha(d.is,d.s),g=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])"),h=P(b);d=h.l;h=h.cssBuild;var k=hb(d,e);return M(b,d,function(b){var d="";b.f||Q(b);b.f.cssText&&(d=cb(a,b.f.cssText,c));b.cssText=d;if(!r&&!xa(b)&&b.cssText){var h=d=b.cssText;null==b.B&&(b.B=ta.test(d));if(b.B)if(null==b.u){b.u=[];for(var m in k)h=k[m],h=h(d),d!==h&&(d=h,b.u.push(m))}else{for(m=0;m<b.u.length;++m)h=k[b.u[m]],d=h(d);h=d}b.cssText=h;b.h=b.h||b.selector;
d="."+e;m=Ba(b.h);h=0;for(var wb=m.length,O=void 0;h<wb&&(O=m[h]);h++)m[h]=O.match(g)?O.replace(f,d):d+" "+O;b.selector=m.join(",")}},h)}function hb(a,b){a=a.b;var c={};if(!r&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,g=b;f.g=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+g;f.h=f.h||f.selector;f.selector=f.h.replace(f.keyframesName,f.a);c[d.keyframesName]=ib(d)}return c}function ib(a){return function(b){return b.replace(a.g,a.a)}}
...
a)}else tb()})}mb=function(){qb(rb.takeRecords())}}var ub=mb;var W={};var vb=Promise.resolve();function xb(a){if(a=W[a])a._applyShimCurrentVersion=a._applyShimCurrentVersion||0,a._applyShimValidatingVersion=a._applyShimValidatingVersion||0,a._applyShimNextVersion=(a._applyShimNextVersion||0)+1}function yb(a){return a._applyShimCurrentVersion===a._applyShimNextVersion}function zb(a){a._applyShimValidatingVersion=a._applyShimNextVersion;a._validating||(a._validating=!0,vb.then(function(){a._applyShimCurrentVersion=a._applyShimNextVersion;a._validating=!1}))};var Ab=new lb;function X(){this.A={};this.c=document.documentElement;var a=new n;a.rules=[];this.g=Ya(this.c,new N(a));this.v=!1;this.b=this.a=null}l=X.prototype;l.flush=function(){ub()};l.H=function(a){return A(a)};l.O=function(a){return y(a)};l.prepareTemplate=function(a,b,c){this.prepareTemplateDom(a,b);this.prepareTemplateStyles(a,b,c)};
l.prepareTemplateStyles=function(a,b,c){if(!a._prepared){r||U[b]||(U[b]=za(b));a._prepared=!0;a.name=b;a.extends=c;W[b]=a;var e=H(a),d=Ca(e);c={is:b,extends:c};var f=[];for(var g=a.content.querySelectorAll("style"),h=0;h<g.length;h++){var k=g[h];if(k.hasAttribute("shady-unscoped")){if(!r){var m=k.textContent;wa.has(m)||(wa.add(m),m=k.cloneNode(!0),document.head.appendChild(m));k.parentNode.removeChild(k)}}else f.push(k.textContent),k.parentNode.removeChild(k)}f=f.join("").trim();Y(this);if(!d){if(g=
!e)g=x.test(f)||w.test(f),x.lastIndex=0,w.lastIndex=0;h=p(f);g&&u&&this.a&&this.a.transformRules(h,b);a._styleAst=h}g=[];u||(g=bb(a._styleAst));if(!g.length||u)h=r?a.content:null,b=U[b]||null,e=M(c,a._styleAst,null,e,d?f:""),e=e.length?B(e,c.is,h,b):null,a._style=e;a.a=g}};l.prepareTemplateDom=function(a,b){var c=H(a);r||"shady"===c||a._domPrepared||(a._domPrepared=!0,Da(a.content,b))};
function Bb(a){!a.b&&window.ShadyCSS&&window.ShadyCSS.CustomStyleInterface&&(a.b=window.ShadyCSS.CustomStyleInterface,a.b.transformCallback=function(b){a.C(b)},a.b.validateCallback=function(){requestAnimationFrame(function(){(a.b.enqueued||a.v)&&a.flushCustomStyles()})})}function Y(a){!a.a&&window.ShadyCSS&&window.ShadyCSS.ApplyShim&&(a.a=window.ShadyCSS.ApplyShim,a.a.invalidCallback=xb);Bb(a)}
l.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued&&!Ca(this.g.cssBuild)){if(u){if(!this.g.cssBuild)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&u&&this.a){var e=A(c);Y(this);this.a.transformRules(e);c.textContent=y(e)}}}else{Cb(this,this.c,this.g);for(b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&jb(c,this.g.m);this.v&&this.styleDocument()}this.b.enqueued=!1}}};
l.styleElement=function(a,b){var c=P(a);if(!c){var e=G(a);c=e.is;e=e.s;var d=U[c]||null;c=W[c];if(c){var f=c._styleAst;var g=c.a;var h=H(c)}f=new N(f,d,g,e,h);c&&Ya(a,f);c=f}a!==this.c&&(this.v=!0);b&&(c.o=c.o||{},Object.assign(c.o,b));if(u){b=c;f=G(a).is;if(b.o){g=b.o;for(var k in g)null===k?a.style.removeProperty(k):a.style.setProperty(k,g[k])}if(!(!(k=W[f])&&a!==this.c||k&&""!==H(k))&&k&&k._style&&!yb(k)){if(yb(k)||k._applyShimValidatingVersion!==k._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(k._styleAst,
f),k._style.textContent=M(a,b.l),zb(k);r&&(f=a.shadowRoot)&&(f=f.querySelector("style"))&&(f.textContent=M(a,b.l));b.l=k._styleAst}}else if(k=c,this.flush(),Cb(this,a,k),k.c&&k.c.length){b=G(a).is;a:{if(f=Ab.cache[b])for(g=f.length-1;0<=g;g--){h=f[g];b:{c=k.c;for(e=0;e<c.length;e++)if(d=c[e],h.j[d]!==k.m[d]){c=!1;break b}c=!0}if(c){f=h;break a}}f=void 0}c=f?f.styleElement:null;g=k.i;(h=f&&f.i)||(h=this.A[b]=(this.A[b]||0)+1,h=b+"-"+h);k.i=h;h=k.i;e=T;e=c?c.textContent||"":gb(e,a,k.m,h);d=P(a);var m=
d.a;m&&!r&&m!==c&&(m._useCount--,0>=m._useCount&&m.parentNode&&m.parentNode.removeChild(m));r?d.a?(d.a.textContent=e,c=d.a):e&&(c=B(e,h,a.shadowRoot,d.b)):c?c.parentNode||($a&&-1<e.indexOf("@media")&&(c.textContent=e),ya(c,null,d.b)):e&&(c=B(e,h,null,d.b));c&&(c._useCount=c._useCount||0,d.a!=c&&c._useCount++,d.a=c);h=c;r||(c=k.i,d=e=a.getAttribute("class")||"",g&&(d=e.replace(new RegExp("\\s*x-scope\\s*"+g+"\\s*","g")," ")),d+=(d?" ":"")+"x-scope "+c,e!==d&&E(a,d));f||Ab.store(b,k.m,h,k.i)}};
function Db(a,b){return(b=F(b).getRootNode().host)?P(b)?b:Db(a,b):a.c}function Cb(a,b,c){a=Db(a,b);var e=P(a);a=Object.create(e.m||null);var d=fb(b,c.l,c.cssBuild);b=db(e.l,b).j;Object.assign(a,d.I,b,d.K);b=c.o;for(var f in b)if((d=b[f])||0===d)a[f]=d;f=T;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=S(f,a[e],a);c.m=a}l.styleDocument=function(a){this.styleSubtree(this.c,a)};
...
l.C=function(a){var b=this,c=H(a);c!==this.g.cssBuild&&(this.g.cssBuild=c);if(!Ca(c)){var e=A(a);z(e,function(a){if(r)Xa(a);else{var d=K;a.selector=a.parsedSelector;Xa(a);a.selector=a.h=Ia(d,a,d.c,void 0,void 0)}u&&""===c&&(Y(b),b.a&&b.a.transformRule(a))});u?a.textContent=y(e):this.g.l.rules.push(e)}};l.getComputedStyleValue=function(a,b){var c;u||(c=(P(a)||P(Db(this,a))).m[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};
l.N=function(a,b){var c=F(a).getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===K.a){c=e[d+1];break}}}c&&b.push(K.a,c);u||(c=P(a))&&c.i&&b.push(T.a,c.i);E(a,b.join(" "))};l.D=function(a){return P(a)};l.M=function(a,b){L(a,b)};l.P=function(a,b){L(a,b,!0)};l.L=function(a){return pb(a)};l.G=function(a){return ob(a)};X.prototype.flush=X.prototype.flush;X.prototype.prepareTemplate=X.prototype.prepareTemplate;
