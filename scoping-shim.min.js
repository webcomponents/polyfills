...
function K(a,b,c){var e=J,d=a.__cssBuild;v||"shady"===d?b=y(b,c):(a=E(a),b=Ha(e,b,a.is,a.u,c)+"\n\n");return b.trim()}function Ha(a,b,c,e,d){var f=L(c,e);c=c?Ia+c:"";return y(b,function(b){b.c||(b.selector=b.g=N(a,b,a.b,c,f),b.c=!0);d&&d(b,c,f)})}function L(a,b){return b?"[is="+a+"]":a}function N(a,b,c,e,d){var f=b.selector.split(Ja);if(!Aa(b)){b=0;for(var g=f.length,h;b<g&&(h=f[b]);b++)f[b]=c.call(a,h,e,d)}return f.join(Ja)}
...
function nb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=E(b);a=b.is;b=b.u;b=a?L(a,b):"html";var f=c.parsedSelector,g=":host > *"===f||"html"===f,h=0===f.indexOf(":host")&&!g;"shady"===e&&(g=f===b+" > *."+b||-1!==f.indexOf("html"),h=!g&&0===f.indexOf(b));"shadow"===e&&(g=":host > *"===f||"html"===f,h=h&&!g);if(g||h)e=b,h&&(v&&!c.g&&(c.g=N(J,c,J.b,a?Ia+a:"",b)),e=c.g||b),d({M:e,K:h,S:g})}}
...
for(var k=0,wb=q.length,M;k<wb&&(M=q[k]);k++)q[k]=M.match(g)?M.replace(f,d):d+" "+M;b.selector=q.join(",")}})}function qb(a,b){a=a.b;var c={};if(!v&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,g=b;f.l=new RegExp(f.keyframesName,"g");f.a=f.keyframesName+"-"+g;f.g=f.g||f.selector;f.selector=f.g.replace(f.keyframesName,f.a);c[d.keyframesName]=rb(d)}return c}function rb(a){return function(b){return b.replace(a.l,a.a)}}
...
x.parentNode.removeChild(x));v?f.a?(f.a.textContent=d,e=f.a):d&&(e=B(d,h,a.shadowRoot,f.b)):e?e.parentNode||Ba(e,null,f.b):d&&(e=B(d,h,null,f.b));e&&(e._useCount=e._useCount||0,f.a!=e&&e._useCount++,f.a=e);ib&&(e.textContent=e.textContent);h=e;v||(e=c.h,f=d=a.getAttribute("class")||"",g&&(f=d.replace(new RegExp("\\s*x-scope\\s*"+g+"\\s*","g")," ")),f+=(f?" ":"")+"x-scope "+e,d!==f&&D(a,f));b||(a=W.cache[k]||[],a.push({i:c.m,styleElement:h,h:c.h}),a.length>W.a&&a.shift(),W.cache[k]=a)}};
...
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=A(a);z(c,function(a){if(v)Ya(a);else{var c=J;a.selector=a.parsedSelector;Ya(a);a.selector=a.g=N(c,a,c.c,void 0,void 0)}w&&(Y(b),b.b.transformRule(a))});w?a.textContent=y(c):this.l.j.rules.push(c)};
