...
function Ha(a,b,c,e,d){var f=M(c,e);c=c?Ia+c:"";return z(b,function(b){b.c||(b.selector=b.g=Ja(a,b,a.b,c,f),b.c=!0);d&&d(b,c,f)})}function M(a,b){return b?"[is="+a+"]":a}function Ja(a,b,c,e,d){var f=b.selector.split(Ka);if(!za(b)){b=0;for(var g=f.length,h;b<g&&(h=f[b]);b++)f[b]=c.call(a,h,e,d)}return f.join(Ka)}function La(a){return a.replace(Ma,function(a,c,e){-1<e.indexOf("+")?e=e.replace(/\+/g,"___"):-1<e.indexOf("___")&&(e=e.replace(/___/g,"+"));return":"+c+"("+e+")"})}
I.prototype.b=function(a,b,c){var e=!1;a=a.trim();var d=Ma.test(a);d&&(a=a.replace(Ma,function(a,b,c){return":"+b+"("+c.replace(/\s/g,"")+")"}),a=La(a));a=a.replace(Na,Oa+" $1");a=a.replace(Pa,function(a,d,h){e||(a=Qa(h,d,b,c),e=e||a.stop,d=a.H,h=a.value);return d+h});d&&(a=La(a));return a};
...
function Sa(a,b){var c=a.match(Xa);return(c=c&&c[2].trim()||"")?c[0].match(Ya)?a.replace(Xa,function(a,c,f){return b+f}):c.split(Ya)[0]===b?c:Za:a.replace($a,b)}function ab(a){a.selector===bb&&(a.selector="html")}I.prototype.c=function(a){return a.match(Ra)?this.b(a,cb):Ta(a.trim(),cb)};aa.Object.defineProperties(I.prototype,{a:{configurable:!0,enumerable:!0,get:function(){return"style-scope"}}});
var Ma=/:(nth[-\w]+)\(([^)]+)\)/,cb=":not(.style-scope)",Ka=",",Pa=/(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g,Ya=/[[.:#*]/,Oa=":host",bb=":root",Ra="::slotted",Na=new RegExp("^("+Ra+")"),$a=/:host(?!-context)/g,Xa=/(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Ua=/(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Va=/(.*):dir\((?:(ltr|rtl))\)/,Ia=".",Wa=":",Ga="class",Za="should_not_match",K=new I;function db(){}
...
f.host))if(f=F(f).is,g===f)for(d=window.ShadyDOM.nativeMethods.querySelectorAll.call(d,":not(."+K.a+")"),f=0;f<d.length;f++)Fa(d[f],g);else g&&J(d,g,!0),J(d,f)}}}}
...
function T(a,b,c){b&&(b=0<=b.indexOf(";")?ob(a,b,c):Ba(b,function(b,d,f,g){if(!d)return b+g;(d=T(a,c[d],c))&&"initial"!==d?"apply-shim-inherit"===d&&(d="inherit"):d=T(a,c[f]||f,c)||f;return b+(d||"")+g}));return b&&b.trim()||""}
function ob(a,b,c){b=b.split(";");for(var e=0,d,f;e<b.length;e++)if(d=b[e]){y.lastIndex=0;if(f=y.exec(d))d=T(a,c[f[1]],c);else if(f=d.indexOf(":"),-1!==f){var g=d.substring(f);g=g.trim();g=T(a,g,c)||g;d=d.substring(0,f)+g}b[e]=d&&d.lastIndexOf(";")===d.length-1?d.slice(0,-1):d||""}return b.join(";")}
...
function qb(a,b,c,e,d){c.f||R(c);if(c.f.i){b=F(b);a=b.is;b=b.u;b=a?M(a,b):"html";var f=c.parsedSelector,g=":host > *"===f||"html"===f,h=0===f.indexOf(":host")&&!g;"shady"===e&&(g=f===b+" > *."+b||-1!==f.indexOf("html"),h=!g&&0===f.indexOf(b));"shadow"===e&&(g=":host > *"===f||"html"===f,h=h&&!g);if(g||h)e=b,h&&(t&&!c.g&&(c.g=Ja(K,c,K.b,a?Ia+a:"",b)),e=c.g||b),d({M:e,K:h,S:g})}}
...
l.styleSubtree=function(a,b){var c=a.shadowRoot;(c||a===this.c)&&this.styleElement(a,b);if(b=c&&(c.children||c.childNodes))for(a=0;a<b.length;a++)this.styleSubtree(b[a]);else if(a=a.children||a.childNodes)for(b=0;b<a.length;b++)this.styleSubtree(a[b])};l.D=function(a){var b=this,c=B(a);A(c,function(a){if(t)ab(a);else{var c=K;a.selector=a.parsedSelector;ab(a);a.selector=a.g=Ja(c,a,c.c,void 0,void 0)}v&&(Y(b),b.a&&b.a.transformRule(a))});v?a.textContent=z(c):this.l.j.rules.push(c)};
