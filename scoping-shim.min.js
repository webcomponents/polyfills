...
function fb(a,b,c,e){var d=F(b),f=Ga(d.is,d.s),g=new RegExp("(?:^|[^.#[:])"+(b.extends?"\\"+f.slice(0,-1)+"\\]":f)+"($|[.:[\\s>+~])"),h=P(b);d=h.m;h=h.cssBuild;var l=gb(d,e);return M(b,d,function(b){var d="";b.f||Q(b);b.f.cssText&&(d=bb(a,b.f.cssText,c));b.cssText=d;if(!r&&!xa(b)&&b.cssText){var h=d=b.cssText;null==b.B&&(b.B=ta.test(d));if(b.B)if(null==b.u){b.u=[];for(var m in l)h=l[m],h=h(d),d!==h&&(d=h,b.u.push(m))}else{for(m=0;m<b.u.length;++m)h=l[b.u[m]],d=h(d);h=d}b.cssText=h;b.h=b.h||b.selector;
d="."+e;m=Ba(b.h);h=0;for(var wb=m.length,O=void 0;h<wb&&(O=m[h]);h++)m[h]=O.match(g)?O.replace(f,d):d+" "+O;b.selector=m.join(",")}},h)}function gb(a,b){a=a.b;var c={};if(!r&&a)for(var e=0,d=a[e];e<a.length;d=a[++e]){var f=d,g=b;f.g=new RegExp("\\b"+f.keyframesName+"(?!\\B|-)","g");f.a=f.keyframesName+"-"+g;f.h=f.h||f.selector;f.selector=f.h.replace(f.keyframesName,f.a);c[d.keyframesName]=hb(d)}return c}function hb(a){return function(b){return b.replace(a.g,a.a)}}
...
a)}else sb()})}lb=function(){pb(qb.takeRecords())}}var tb=lb;var W={};var ub=Promise.resolve();function vb(a){if(a=W[a])a._applyShimCurrentVersion=a._applyShimCurrentVersion||0,a._applyShimValidatingVersion=a._applyShimValidatingVersion||0,a._applyShimNextVersion=(a._applyShimNextVersion||0)+1}function xb(a){return a._applyShimCurrentVersion===a._applyShimNextVersion}function yb(a){a._applyShimValidatingVersion=a._applyShimNextVersion;a._validating||(a._validating=!0,ub.then(function(){a._applyShimCurrentVersion=a._applyShimNextVersion;a._validating=!1}))};var zb=new kb;function X(){this.A={};this.c=document.documentElement;var a=new n;a.rules=[];this.g=Xa(this.c,new N(a));this.v=!1;this.b=this.a=null}k=X.prototype;k.flush=function(){tb()};k.H=function(a){return A(a)};k.O=function(a){return y(a)};k.prepareTemplate=function(a,b,c){this.prepareTemplateDom(a,b);this.prepareTemplateStyles(a,b,c)};
k.prepareTemplateStyles=function(a,b,c){if(!a._prepared){r||U[b]||(U[b]=za(b));a._prepared=!0;a.name=b;a.extends=c;W[b]=a;var e=G(a),d=H(e);c={is:b,extends:c};var f=[];for(var g=a.content.querySelectorAll("style"),h=0;h<g.length;h++){var l=g[h];if(l.hasAttribute("shady-unscoped")){if(!r){var m=l.textContent;wa.has(m)||(wa.add(m),m=l.cloneNode(!0),document.head.appendChild(m));l.parentNode.removeChild(l)}}else f.push(l.textContent),l.parentNode.removeChild(l)}f=f.join("").trim();Y(this);if(!d){if(g=
!e)g=x.test(f)||w.test(f),x.lastIndex=0,w.lastIndex=0;h=p(f);g&&u&&this.a&&this.a.transformRules(h,b);a._styleAst=h}g=[];u||(g=ab(a._styleAst));if(!g.length||u)h=r?a.content:null,b=U[b]||null,e=M(c,a._styleAst,null,e,d?f:""),e=e.length?B(e,c.is,h,b):null,a._style=e;a.a=g}};k.prepareTemplateDom=function(a,b){var c=G(a);r||"shady"===c||a._domPrepared||(a._domPrepared=!0,Ca(a.content,b))};
function Ab(a){var b=F(a),c=b.is;b=b.s;var e=U[c]||null;c=W[c];if(c){var d=c._styleAst;var f=c.a;var g=G(c)}d=new N(d,e,f,b,g);c&&Xa(a,d);return d}function Bb(a){!a.b&&window.ShadyCSS&&window.ShadyCSS.CustomStyleInterface&&(a.b=window.ShadyCSS.CustomStyleInterface,a.b.transformCallback=function(b){a.C(b)},a.b.validateCallback=function(){requestAnimationFrame(function(){(a.b.enqueued||a.v)&&a.flushCustomStyles()})})}
function Y(a){!a.a&&window.ShadyCSS&&window.ShadyCSS.ApplyShim&&(a.a=window.ShadyCSS.ApplyShim,a.a.invalidCallback=vb);Bb(a)}
k.flushCustomStyles=function(){Y(this);if(this.b){var a=this.b.processStyles();if(this.b.enqueued&&!H(this.g.cssBuild)){if(u){if(!this.g.cssBuild)for(var b=0;b<a.length;b++){var c=this.b.getStyleForCustomStyle(a[b]);if(c&&u&&this.a){var e=A(c);Y(this);this.a.transformRules(e);c.textContent=y(e)}}}else{Cb(this,this.c,this.g);for(b=0;b<a.length;b++)(c=this.b.getStyleForCustomStyle(a[b]))&&ib(c,this.g.l);this.v&&this.styleDocument()}this.b.enqueued=!1}}};
k.styleElement=function(a,b){var c=P(a);c||(c=Ab(a));a!==this.c&&(this.v=!0);b&&(c.o=c.o||{},Object.assign(c.o,b));if(u){b=c;c=F(a).is;if(b.o){var e=b.o,d;for(d in e)null===d?a.style.removeProperty(d):a.style.setProperty(d,e[d])}if(!(!(d=W[c])&&a!==this.c||d&&""!==G(d))&&d&&d._style&&!xb(d)){if(xb(d)||d._applyShimValidatingVersion!==d._applyShimNextVersion)Y(this),this.a&&this.a.transformRules(d._styleAst,c),d._style.textContent=M(a,b.m),yb(d);r&&(c=a.shadowRoot)&&(c=c.querySelector("style"))&&(c.textContent=
M(a,b.m));b.m=d._styleAst}}else if(b=c,this.flush(),Cb(this,a,b),b.c&&b.c.length){d=F(a).is;a:{if(c=zb.cache[d])for(e=c.length-1;0<=e;e--){var f=c[e];b:{var g=b.c;for(var h=0;h<g.length;h++){var l=g[h];if(f.j[l]!==b.l[l]){g=!1;break b}}g=!0}if(g){c=f;break a}}c=void 0}g=c?c.styleElement:null;e=b.i;(f=c&&c.i)||(f=this.A[d]=(this.A[d]||0)+1,f=d+"-"+f);b.i=f;f=b.i;h=T;h=g?g.textContent||"":fb(h,a,b.l,f);l=P(a);var m=l.a;m&&!r&&m!==g&&(m._useCount--,0>=m._useCount&&m.parentNode&&m.parentNode.removeChild(m));
r?l.a?(l.a.textContent=h,g=l.a):h&&(g=B(h,f,a.shadowRoot,l.b)):g?g.parentNode||(Za&&-1<h.indexOf("@media")&&(g.textContent=h),ya(g,null,l.b)):h&&(g=B(h,f,null,l.b));g&&(g._useCount=g._useCount||0,l.a!=g&&g._useCount++,l.a=g);f=g;r||(g=b.i,l=h=a.getAttribute("class")||"",e&&(l=h.replace(new RegExp("\\s*x-scope\\s*"+e+"\\s*","g")," ")),l+=(l?" ":"")+"x-scope "+g,h!==l&&E(a,l));c||zb.store(d,b.l,f,b.i)}};function Db(a,b){return(b=b.getRootNode().host)?P(b)||Ab(b)?b:Db(a,b):a.c}
function Cb(a,b,c){var e=Db(a,b),d=P(e),f=d.l;e===a.c||f||(Cb(a,e,d),f=d.l);a=Object.create(f||null);e=eb(b,c.m,c.cssBuild);b=cb(d.m,b).j;Object.assign(a,e.I,b,e.K);b=c.o;for(var g in b)if((d=b[g])||0===d)a[g]=d;g=T;b=Object.getOwnPropertyNames(a);for(d=0;d<b.length;d++)e=b[d],a[e]=S(g,a[e],a);c.l=a}k.styleDocument=function(a){this.styleSubtree(this.c,a)};
...
k.C=function(a){var b=this,c=G(a);c!==this.g.cssBuild&&(this.g.cssBuild=c);if(!H(c)){var e=A(a);z(e,function(a){if(r)Wa(a);else{var d=K;a.selector=a.parsedSelector;Wa(a);a.selector=a.h=Ha(d,a,d.c,void 0,void 0)}u&&""===c&&(Y(b),b.a&&b.a.transformRule(a))});u?a.textContent=y(e):this.g.m.rules.push(e)}};k.getComputedStyleValue=function(a,b){var c;u||(c=(P(a)||P(Db(this,a))).l[b]);return(c=c||window.getComputedStyle(a).getPropertyValue(b))?c.trim():""};
k.N=function(a,b){var c=a.getRootNode();b=b?b.split(/\s/):[];c=c.host&&c.host.localName;if(!c){var e=a.getAttribute("class");if(e){e=e.split(/\s/);for(var d=0;d<e.length;d++)if(e[d]===K.a){c=e[d+1];break}}}c&&b.push(K.a,c);u||(c=P(a))&&c.i&&b.push(T.a,c.i);E(a,b.join(" "))};k.D=function(a){return P(a)};k.M=function(a,b){L(a,b)};k.P=function(a,b){L(a,b,!0)};k.L=function(a){return ob(a)};k.G=function(a){return nb(a)};X.prototype.flush=X.prototype.flush;X.prototype.prepareTemplate=X.prototype.prepareTemplate;
...
X.prototype.scopeNode=X.prototype.M;X.prototype.unscopeNode=X.prototype.P;X.prototype.scopeForNode=X.prototype.L;X.prototype.currentScopeForNode=X.prototype.G;Object.defineProperties(X.prototype,{nativeShadow:{get:function(){return r}},nativeCss:{get:function(){return u}}});var Z=new X,Eb,Fb;window.ShadyCSS&&(Eb=window.ShadyCSS.ApplyShim,Fb=window.ShadyCSS.CustomStyleInterface);
window.ShadyCSS={ScopingShim:Z,prepareTemplate:function(a,b,c){Z.flushCustomStyles();Z.prepareTemplate(a,b,c)},prepareTemplateDom:function(a,b){Z.prepareTemplateDom(a,b)},prepareTemplateStyles:function(a,b,c){Z.flushCustomStyles();Z.prepareTemplateStyles(a,b,c)},styleSubtree:function(a,b){Z.flushCustomStyles();Z.styleSubtree(a,b)},styleElement:function(a){Z.flushCustomStyles();Z.styleElement(a)},styleDocument:function(a){Z.flushCustomStyles();Z.styleDocument(a)},flushCustomStyles:function(){Z.flushCustomStyles()},
getComputedStyleValue:function(a,b){return Z.getComputedStyleValue(a,b)},nativeCss:u,nativeShadow:r,cssBuild:v};Eb&&(window.ShadyCSS.ApplyShim=Eb);Fb&&(window.ShadyCSS.CustomStyleInterface=Fb);}).call(this);
