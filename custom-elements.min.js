...
function A(b,a,e){e=void 0===e?{}:e;var c=e.w||new Set,d=e.s||function(d){return y(b,d)},f=[];n(a,function(a){if("link"===a.localName&&"import"===a.getAttribute("rel")){var e=a.import;e instanceof Node&&"complete"===e.readyState?(e.__CE_isImportDocument=!0,e.__CE_hasRegistry=!0):a.addEventListener("load",function(){var e=a.import;e.__CE_documentLoadHandled||(e.__CE_documentLoadHandled=!0,e.__CE_isImportDocument=!0,e.__CE_hasRegistry=!0,c.delete(e),A(b,e,{w:c,s:d}))})}else f.push(a)},c);if(b.b)for(a=
0;a<f.length;a++)w(b,f[a]);for(a=0;a<f.length;a++)d(f[a])}
