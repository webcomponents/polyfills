...
D.prototype.j=function(b,a){var e=this;if(!(a instanceof Function))throw new TypeError("Custom element constructors must be functions.");if(!k(b))throw new SyntaxError("The element name '"+b+"' is not valid.");if(this.a.a.get(b))throw Error("A custom element with name '"+b+"' has already been defined.");if(this.g)throw Error("A custom element is already being defined.");this.g=!0;var d,c,f,g,w;try{var q=function(b){var a=O[b];if(void 0!==a&&!(a instanceof Function))throw Error("The '"+b+"' callback must be a function.");
return a},O=a.prototype;if(!(O instanceof Object))throw new TypeError("The custom element constructor's prototype is not an object.");d=q("connectedCallback");c=q("disconnectedCallback");f=q("adoptedCallback");g=q("attributeChangedCallback");w=a.observedAttributes||[]}catch(va){return}finally{this.g=!1}ba(this.a,b,{localName:b,constructor:a,connectedCallback:d,disconnectedCallback:c,adoptedCallback:f,attributeChangedCallback:g,observedAttributes:w,constructionStack:[]});this.b||this.c?(this.h.push(b),
...
c[f],g instanceof Element&&y(b,g)}};function qa(){var b=X;p(Document.prototype,"createElement",function(a){if(this.__CE_hasRegistry){var e=b.a.get(a);if(e)return new e.constructor}a=G.call(this,a);x(b,a);return a});p(Document.prototype,"importNode",function(a,e){a=ea.call(this,a,e);this.__CE_hasRegistry?B(b,a):v(b,a);return a});p(Document.prototype,"createElementNS",function(a,e){if(this.__CE_hasRegistry&&(null===a||"http://www.w3.org/1999/xhtml"===a)){var d=b.a.get(e);if(d)return new d.constructor}a=da.call(this,a,e);x(b,a);return a});
...
P.get)a(Element.prototype,P);else if(W&&W.get)a(HTMLElement.prototype,W);else{var e=G.call(document,"div");u(b,function(b){a(b,{enumerable:!0,configurable:!0,get:function(){return H.call(this,!0).innerHTML},set:function(a){var b="template"===this.localName?this.content:this;for(e.innerHTML=a;0<b.childNodes.length;)K.call(b,b.childNodes[0]);for(;0<e.childNodes.length;)I.call(b,e.childNodes[0])}})})}p(Element.prototype,"setAttribute",function(a,c){if(this.__CE_state!==r.custom)return R.call(this,a,
c);var e=Q.call(this,a);R.call(this,a,c);c=Q.call(this,a);e!==c&&b.attributeChangedCallback(this,a,e,c,null)});p(Element.prototype,"setAttributeNS",function(a,c,e){if(this.__CE_state!==r.custom)return U.call(this,a,c,e);var g=T.call(this,a,c);U.call(this,a,c,e);e=T.call(this,a,c);g!==e&&b.attributeChangedCallback(this,c,g,e,a)});p(Element.prototype,"removeAttribute",function(a){if(this.__CE_state!==r.custom)return S.call(this,a);var c=Q.call(this,a);S.call(this,a);null!==c&&b.attributeChangedCallback(this,
a,c,null,null)});p(Element.prototype,"remoteAttributeNS",function(a,c){if(this.__CE_state!==r.custom)return V.call(this,a,c);var e=T.call(this,a,c);V.call(this,a,c);null!==e&&b.attributeChangedCallback(this,c,e,null,a)});p(Element.prototype,"insertAdjacentElement",function(a,c){var e=l(c);a=ha.call(this,a,c);e&&A(b,c);l(a)&&y(b,c);return a});Y(b,Element.prototype,{i:ia,append:ja});sa(b)};/*
