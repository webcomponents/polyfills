...
D.prototype.j=function(b,a){var e=this;if(!(a instanceof Function))throw new TypeError("Custom element constructors must be functions.");if(!k(b))throw new SyntaxError("The element name '"+b+"' is not valid.");if(this.a.a.get(b))throw Error("A custom element with name '"+b+"' has already been defined.");if(this.g)throw Error("A custom element is already being defined.");this.g=!0;var d,c,f,g,v;try{var q=function(b){var a=O[b];if(void 0!==a&&!(a instanceof Function))throw Error("The '"+b+"' callback must be a function.");
return a},O=a.prototype;if(!(O instanceof Object))throw new TypeError("The custom element constructor's prototype is not an object.");d=q("connectedCallback");c=q("disconnectedCallback");f=q("adoptedCallback");g=q("attributeChangedCallback");v=a.observedAttributes||[]}catch(va){return}finally{this.g=!1}ba(this.a,b,{localName:b,constructor:a,connectedCallback:d,disconnectedCallback:c,adoptedCallback:f,attributeChangedCallback:g,observedAttributes:v,constructionStack:[]});this.b||this.c?(this.h.push(b),
