...
null,f,null)}m(a)&&b.connectedCallback(a)}}}u.prototype.connectedCallback=function(b){var a=b.__CE_definition;a.connectedCallback&&a.connectedCallback.call(b)};u.prototype.disconnectedCallback=function(b){var a=b.__CE_definition;a.disconnectedCallback&&a.disconnectedCallback.call(b)};u.prototype.attributeChangedCallback=function(b,a,e,d,c){var f=b.__CE_definition;f.attributeChangedCallback&&-1<f.observedAttributes.indexOf(a)&&f.attributeChangedCallback.call(b,a,e,d,c)};function D(b,a){this.c=b;this.a=a;this.b=void 0;C(this.c,this.a);"loading"===this.a.readyState&&(this.b=new MutationObserver(this.f.bind(this)),this.b.observe(this.a,{childList:!0,subtree:!0}))}D.prototype.f=function(b){var a=this.a.readyState;"interactive"!==a&&"complete"!==a||this.b.disconnect();for(a=0;a<b.length;a++)for(var e=b[a].addedNodes,d=0;d<e.length;d++)C(this.c,e[d])};function ba(){var b=this;this.b=this.a=void 0;this.c=new Promise(function(a){b.b=a;b.a&&a(b.a)})}function E(b){if(b.a)throw Error("Already resolved.");b.a=void 0;b.b&&b.b(void 0)};function F(b){this.f=!1;this.a=b;this.h=new Map;this.g=function(b){return b()};this.b=!1;this.c=[];this.j=new D(b,document)}
F.prototype.l=function(b,a){var e=this;if(!(a instanceof Function))throw new TypeError("Custom element constructors must be functions.");if(!l(b))throw new SyntaxError("The element name '"+b+"' is not valid.");if(this.a.a.get(b))throw Error("A custom element with name '"+b+"' has already been defined.");if(this.f)throw Error("A custom element is already being defined.");this.f=!0;var d,c,f,g,v;try{var q=function(b){var d=P[b];if(void 0!==d&&!(d instanceof Function))throw Error("The '"+b+"' callback must be a function.");
return d},P=a.prototype;if(!(P instanceof Object))throw new TypeError("The custom element constructor's prototype is not an object.");d=q("connectedCallback");c=q("disconnectedCallback");f=q("adoptedCallback");g=q("attributeChangedCallback");v=a.observedAttributes||[]}catch(ua){return}finally{this.f=!1}aa(this.a,b,{localName:b,constructor:a,connectedCallback:d,disconnectedCallback:c,adoptedCallback:f,attributeChangedCallback:g,observedAttributes:v,constructionStack:[]});this.c.push(b);this.b||(this.b=
!0,this.g(function(){if(!1!==e.b)for(e.b=!1,C(e.a,document);0<e.c.length;){var b=e.c.shift();(b=e.h.get(b))&&E(b)}}))};F.prototype.get=function(b){if(b=this.a.a.get(b))return b.constructor};F.prototype.o=function(b){if(!l(b))return Promise.reject(new SyntaxError("'"+b+"' is not a valid custom element name."));var a=this.h.get(b);if(a)return a.c;a=new ba;this.h.set(b,a);this.a.a.get(b)&&-1===this.c.indexOf(b)&&E(a);return a.c};F.prototype.m=function(b){this.j.b.disconnect();var a=this.g;this.g=function(e){return b(function(){return a(e)})}};
...
a,c,null,null)});r(Element.prototype,"removeAttributeNS",function(a,c){if(this.__CE_state!==t.custom)return V.call(this,a,c);var e=T.call(this,a,c);V.call(this,a,c);null!==e&&b.attributeChangedCallback(this,c,e,null,a)});r(Element.prototype,"insertAdjacentElement",function(a,c){var e=m(c);a=ga.call(this,a,c);e&&B(b,c);m(a)&&z(b,c);return a});Y(b,Element.prototype,{i:ha,append:ia});ra(b)};/*
