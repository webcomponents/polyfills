...
var promish$$module$$src$utils,twiddle$$module$$src$utils=document.createTextNode(""),content$$module$$src$utils=0;promish$$module$$src$utils={then:function(a){var b=new MutationObserver(function(){b.disconnect();a()});b.observe(twiddle$$module$$src$utils,{characterData:!0});twiddle$$module$$src$utils.textContent=content$$module$$src$utils++}};module$$src$utils.settings=settings$$module$$src$utils;module$$src$utils.isShadyRoot=isShadyRoot$$module$$src$utils;
module$$src$utils.ownerShadyRootForNode=ownerShadyRootForNode$$module$$src$utils;module$$src$utils.matchesSelector=matchesSelector$$module$$src$utils;module$$src$utils.extend=extend$$module$$src$utils;module$$src$utils.extendAll=extendAll$$module$$src$utils;module$$src$utils.mixin=mixin$$module$$src$utils;module$$src$utils.patchPrototype=patchPrototype$$module$$src$utils;module$$src$utils.promish=promish$$module$$src$utils;var module$$src$flush={},customElements$$module$$src$flush=window.customElements,flushList$$module$$src$flush=[],scheduled$$module$$src$flush,flushCount$$module$$src$flush=0,flushMax$$module$$src$flush=100;function enqueue$$module$$src$flush(a){scheduled$$module$$src$flush||(scheduled$$module$$src$flush=!0,module$$src$utils.promish.then(flush$$module$$src$flush));flushList$$module$$src$flush.push(a)}
