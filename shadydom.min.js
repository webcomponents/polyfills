...
b.v++;e++;break;case 3:b||(b=t(e,0)),b.l.push(c[f]),f++}b&&k.push(b);return k}function ia(a,b){return a===b};function ja(){this.N=this.root=null;this.A=!1;this.h=this.s=this.G=this.assignedSlot=this.assignedNodes=this.i=null;this.childNodes=this.nextSibling=this.previousSibling=this.lastChild=this.firstChild=this.parentNode=this.j=void 0;this.R=this.I=!1;this.o={}}ja.prototype.toJSON=function(){return{}};function u(a){a.D||(a.D=new ja);return a.D}function v(a){return a&&a.D};var w=window.ShadyDOM||{};w.Y=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var ka=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");w.g=!!(ka&&ka.configurable&&ka.get);w.L=w.force||!w.Y;var la=navigator.userAgent.match("Trident"),ma=navigator.userAgent.match("Edge");void 0===w.O&&(w.O=w.g&&(la||ma));function x(a){return(a=v(a))&&void 0!==a.firstChild}function y(a){return"ShadyRoot"===a.U}function z(a){a=a.getRootNode();if(y(a))return a}
...
Ya=Element.prototype.querySelector,Za=DocumentFragment.prototype.querySelector,$a=Document.prototype.querySelector,ab=Element.prototype.querySelectorAll,bb=DocumentFragment.prototype.querySelectorAll,cb=Document.prototype.querySelectorAll;N.appendChild=Element.prototype.appendChild;N.insertBefore=Ka;N.replaceChild=La;N.removeChild=Ma;N.setAttribute=Na;N.removeAttribute=Oa;N.cloneNode=Pa;N.importNode=Qa;N.addEventListener=Ra;N.removeEventListener=Sa;N.Z=Ta;N.$=Ua;N.dispatchEvent=Va;N.contains=Wa;
N.getElementById=Xa;N.fa=Ya;N.ia=Za;N.da=$a;N.querySelector=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return Ya.call(this,a);case Node.DOCUMENT_NODE:return $a.call(this,a);default:return Za.call(this,a)}};N.ga=ab;N.ja=bb;N.ea=cb;N.querySelectorAll=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return ab.call(this,a);case Node.DOCUMENT_NODE:return cb.call(this,a);default:return bb.call(this,a)}};function db(a){for(;a.firstChild;)a.removeChild(a.firstChild)}
...
function tb(a){var b=u(a);if(void 0===b.firstChild){b.childNodes=null;var c=rb(a);b.firstChild=c[0]||null;b.lastChild=c[c.length-1]||null;qb(a);for(b=0;b<c.length;b++){var d=c[b],e=u(d);e.parentNode=a;e.nextSibling=c[b+1]||null;e.previousSibling=c[b-1]||null;pb(d)}}};var ub=M.parentNode,vb=M.childNodes,wb={},S=w.deferNativeCustomElementsConnection&&"loading"===document.readyState,T;function xb(a){var b=[];do b.unshift(a);while(a=a.parentNode);return b}
function R(a,b,c){if(a!==wb)throw new TypeError("Illegal constructor");this.U="ShadyRoot";this.host=b;this.X=c&&c.mode;tb(b);a=u(b);a.root=this;a.N="closed"!==this.X?this:null;a=u(this);a.firstChild=a.lastChild=a.parentNode=a.nextSibling=a.previousSibling=null;a.childNodes=[];this.K=this.u=!1;this.c=this.b=this.a=null;U(this)}function U(a){a.u||(a.u=!0,za(function(){return yb(a)}))}
...
if(window.customElements){var V=new Map;T=function(){var a=Array.from(V);V.clear();a=r(a);for(var b=a.next();!b.done;b=a.next()){b=r(b.value);var c=b.next().value;b.next().value?c.connectedCallback():c.disconnectedCallback()}};S&&document.addEventListener("readystatechange",function(){S=!1;T()},{once:!0});var Gb=function(a){var b=a.prototype.connectedCallback,c=a.prototype.disconnectedCallback,d=0,e="__isConnected"+d++;if(b||c)a.prototype.connectedCallback=function(){S?V.set(this,!0):this[e]||(this[e]=
!0,b&&b.call(this))},a.prototype.disconnectedCallback=function(){S?this.isConnected||V.set(this,!1):this[e]&&(this[e]=!1,c&&c.call(this))};return a},Hb=window.customElements.define;window.customElements.define=function(a,b){return Hb.call(window.customElements,a,Gb(b))}};var Ib=M.parentNode;
...
function nc(a,b,c){if(b){var d=typeof b;if("function"===d||"object"===d)if("object"!==d||b.handleEvent&&"function"===typeof b.handleEvent){var e=this instanceof Window?N.Z:N.addEventListener;if(dc[a])return e.call(this,a,b,c);if(c&&"object"===typeof c){var f=!!c.capture;var g=!!c.once;var h=!!c.passive}else f=!!c,h=g=!1;var k=c&&c.F||this,l=b[W];if(l){if(-1<mc(l,k,a,f,g,h))return}else b[W]=[];l=function(e){g&&this.removeEventListener(a,b,c);e.__target||oc(e);if(k!==this){var f=Object.getOwnPropertyDescriptor(e,
...
f),f=null):delete e.currentTarget);return h}};b[W].push({node:k,type:a,capture:f,once:g,passive:h,aa:l});ic[a]?(this.__handlers=this.__handlers||{},this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]},this.__handlers[a][f?"capture":"bubble"].push(l)):e.call(this,a,l,c)}}}
function pc(a,b,c){if(b){var d=this instanceof Window?N.$:N.removeEventListener;if(dc[a])return d.call(this,a,b,c);if(c&&"object"===typeof c){var e=!!c.capture;var f=!!c.once;var g=!!c.passive}else e=!!c,g=f=!1;var h=c&&c.F||this,k=void 0;var l=null;try{l=b[W]}catch(n){}l&&(f=mc(l,h,a,e,f,g),-1<f&&(k=l.splice(f,1)[0].aa,l.length||(b[W]=void 0)));d.call(this,a,k||b,c);k&&ic[a]&&this.__handlers&&this.__handlers[a]&&(a=this.__handlers[a][e?"capture":"bubble"],k=a.indexOf(k),-1<k&&a.splice(k,1))}}
function qc(){for(var a in ic)window.addEventListener(a,function(a){a.__target||(oc(a),lc(a))},!0)}function oc(a){a.__target=a.target;a.C=a.relatedTarget;if(w.g){var b=Object.getPrototypeOf(a);if(!b.hasOwnProperty("__patchProto")){var c=Object.create(b);c.ba=b;oa(c,gc);b.__patchProto=c}a.__proto__=b.__patchProto}else oa(a,gc)}var rc=hc(window.Event),sc=hc(window.CustomEvent),tc=hc(window.MouseEvent);
