...
function Y(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],f=Object.getOwnPropertyDescriptor(b,e);f.value?a[e]=f.value:Object.defineProperty(a,e,f)}};if(w.H){window.ShadyDOM={inUse:w.H,patch:function(a){qb(a);pb(a);return a},isShadyRoot:y,enqueue:za,flush:C,settings:w,filterMutations:ac,observeChildren:Zb,unobserveChildren:$b,nativeMethods:N,nativeTree:M,deferNativeCustomElementsConnection:!1};uc();var Ic=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Y(R.prototype,Hc);Y(window.Node.prototype,xc);Y(window.Window.prototype,wc);Y(window.Text.prototype,yc);Y(window.DocumentFragment.prototype,zc);Y(window.Element.prototype,
