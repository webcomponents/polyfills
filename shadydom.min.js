...
b[l-1][m-1];else{var q=b[l-1][m]+1,z=b[l][m-1]+1;b[l][m]=q<z?q:z}k=b.length-1;h=b[0].length-1;d=b[k][h];for(a=[];0<k||0<h;)k?h?(f=b[k-1][h-1],l=b[k-1][h],m=b[k][h-1],q=l<m?l<f?l:f:m<f?m:f,q==f?(f==d?a.push(0):(a.push(1),d=f),k--,h--):q==l?(a.push(3),k--,d=l):(a.push(2),h--,d=m)):(a.push(3),k--):(a.push(2),h--);a.reverse();b=void 0;k=[];for(h=0;h<a.length;h++)switch(a[h]){case 0:b&&(k.push(b),b=void 0);e++;g++;break;case 1:b||(b=n(e,0));b.m++;e++;b.j.push(c[g]);g++;break;case 2:b||(b=n(e,0));b.m++;
...
Bb);window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,zb);Z(Eb.prototype,Db);p.h&&(M(window.Node.prototype),M(window.Text.prototype),M(window.DocumentFragment.prototype),M(window.Element.prototype),M(Eb.prototype),M(window.Document.prototype),window.HTMLSlotElement&&M(window.HTMLSlotElement.prototype));window.ShadowRoot=Y};
}).call(self);
