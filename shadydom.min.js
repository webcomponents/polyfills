...
(function () {
  ...
  */
  ...
  function _insertBefore(parent, child, ref_node) {
  ...
  */
  ...
  var mixinImpl = {
    ...
    addNode: function addNode(container, node, ref_node) {
      ...
      var handled = this._maybeDistribute(node, container, ownerRoot, ipAdded) || container.shadyRoot;
      return handled;
    },
    ...
    removeNode: function removeNode(node) {
      ...
      if (logicalParent || ownerRoot) {
        ...
        var removedDistributed = ownerRoot && this._removeDistributedChildren(ownerRoot, node);
    ...
    query: function query(node, matcher, halter) {
      var list = [];
      this._queryElements(node.childNodes, matcher, halter, list);
      return list;
    },
    _queryElements: function _queryElements(elements, matcher, halter, list) {
      for (var i = 0, l = elements.length, c; i < l && (c = elements[i]); i++) {
        if (c.nodeType === Node.ELEMENT_NODE && this._queryElement(c, matcher, halter, list)) {
          return true;
        }
      }
    },
  ...
  var setAttribute$1 = function setAttribute$1(attr, value) {
  ...
  var NodeMixin = {
    ...
    insertBefore: function insertBefore(node, ref_node) {
      ...
      if (!mixinImpl.addNode(this, node, ref_node)) {
        ...
        if (ref_node) {
          _insertBefore(container, node, ref_node);
        } else {
  ...
  var getComposedInnerHTML = function getComposedInnerHTML(node) {
    return getInnerHTML(node, function (n) {
      return getComposedChildNodes(n);
    });
  };
      ...
      value: function distributePool(node, pool) {
        ...
        for (var _i2 = 0; _i2 < pool.length; _i2++) {
          ...
          if (_p3) {
            ...
            var _parent = parentNode(_p3);
            if (_parent) {
              _removeChild(_parent, _p3);
            }
          }
        }
        return dirtyRoots;
    ...
    _updateChildNodes: function _updateChildNodes(container, children$$1) {
      ...
      for (var _i5 = 0, _s, next; _i5 < splices.length && (_s = splices[_i5]); _i5++) {
        ...
        for (var _j2 = _s.index, _n; _j2 < _s.index + _s.addedCount; _j2++) {
          _n = children$$1[_j2];
          _insertBefore(container, _n, next);
