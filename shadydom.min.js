...
(function () {
  ...
  */
  ...
  var appendChild = nativeAppendChild;

  var nativeInsertBefore = Element.prototype.insertBefore;
  var insertBefore = nativeInsertBefore;

  var nativeRemoveChild = Element.prototype.removeChild;
  var removeChild = nativeRemoveChild;

  var nativeSetAttribute = Element.prototype.setAttribute;
  var setAttribute = nativeSetAttribute;

  var nativeRemoveAttribute = Element.prototype.removeAttribute;
  var removeAttribute = nativeRemoveAttribute;

  var nativeCloneNode = Element.prototype.cloneNode;
  var cloneNode = nativeCloneNode;

  var nativeImportNode = Document.prototype.importNode;
  var importNode = nativeImportNode;

  var nativeAddEventListener = Element.prototype.addEventListener;
  var addEventListener = nativeAddEventListener;

  var nativeRemoveEventListener = Element.prototype.removeEventListener;
  var removeEventListener = nativeRemoveEventListener;
  ...
  */
  ...
  function firstComposedNode(insertionPoint) {
    ...
    var root = _getRootNode(insertionPoint);
    ...
    calcEditDistances: function calcEditDistances(current, currentStart, currentEnd, old, oldStart, oldEnd) {
      ...
      for (var j = 0; j < columnCount; j++) {
        ...
        for (var _j = 1; _j < columnCount; _j++) {
          if (this.equals(current[currentStart + _j - 1], old[oldStart + _i2 - 1])) distances[_i2][_j] = distances[_i2 - 1][_j - 1];else {
            var north = distances[_i2 - 1][_j] + 1;
            var west = distances[_i2][_j - 1] + 1;
  ...
  */
  ...
  function tryExtendAccessors(proto, accessors) {
    accessors = accessors || AccessorDescriptors;
    for (var _p2 in accessors) {
      var protoDesc = Object.getOwnPropertyDescriptor(proto, _p2);
      if (protoDesc && protoDesc.configurable) {
        Object.defineProperty(proto, _p2, accessors[_p2]);
      }
    }
  }
  ...
  var Distributor = function () {
    ...
    _createClass(Distributor, [{
      ...
      value: function distributePool(node, pool) {
        ...
        for (var i = 0, l = p$.length, _p3; i < l && (_p3 = p$[i]); i++) {
          this.distributeInsertionPoint(_p3, pool);
          // provoke redistribution on insertion point parents
          // must do this on all candidate hosts since distribution in this
          // scope invalidates their distribution.
          // only get logical parent.
          var parent = _p3.parentNode;
          if (parent && parent.shadyRoot && this.hasInsertionPoint(parent.shadyRoot)) {
            dirtyRoots.push(parent.shadyRoot);
          }
        }
        for (var _i3 = 0; _i3 < pool.length; _i3++) {
          var _p4 = pool[_i3];
          if (_p4) {
            _p4.__shady = _p4.__shady || {};
            _p4.__shady.assignedSlot = undefined;
            // remove undistributed elements from physical dom.
            var _parent2 = parentNode(_p4);
            if (_parent2) {
              removeChild.call(_parent2, _p4);
            }
          }
        }
        return dirtyRoots;
      ...
      value: function distributeInsertionPoint(insertionPoint, pool) {
        ...
        if (prevAssignedNodes) {
          ...
          for (var _i4 = 0; _i4 < prevAssignedNodes.length; _i4++) {
            prevAssignedNodes[_i4].__shady._prevAssignedSlot = null;
          }
  ...
  */
  ...
  var ShadyMixin = {
    ...
    updateInsertionPoints: function updateInsertionPoints() {
      ...
      for (var _i5 = 0, _c; _i5 < i$.length; _i5++) {
        _c = i$[_i5];
    ...
    _composeTree: function _composeTree() {
      ...
      for (var i = 0, l = p$.length, _p5, parent; i < l && (_p5 = p$[i]); i++) {
        parent = _p5.parentNode;
    ...
    _updateChildNodes: function _updateChildNodes(container, children$$1) {
      ...
      // process adds
      for (var _i6 = 0, _s, next; _i6 < splices.length && (_s = splices[_i6]); _i6++) {
  ...
  */
  ...
  var assignedNodes = function assignedNodes(options) {
  ...
  var Element$1 = extendAll({}, Fragment, Slot, {
  ...
  var Document$1 = extendAll({}, Fragment);
  ...
  */
  ...
  if (settings.inUse) {
    ...
    extend(Node.prototype, Node$1);
    extend(Text.prototype, Text$1);
    extend(DocumentFragment.prototype, Fragment);
    extend(Element.prototype, Element$1);
    extend(Document.prototype, Document$1);
    if (window.HTMLSlotElement) {
      extend(HTMLSlotElement.prototype, Slot);
    }
