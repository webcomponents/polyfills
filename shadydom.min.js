...
function innerHTML(node) {
  return getInnerHTML(node, function (n) { return childNodes(n); });
}
...
function insertBefore$1(parent, child, ref_node) {
...
function setAttribute(node, name, value) {
  nativeSetAttribute$1.call(node, name, value);
}
  ...
  insertBefore: function insertBefore(node, ref_node) {
    ...
    if (!mixinImpl.addNode(this, node, ref_node)) {
      ...
      var container = isShadyRoot(this) ?
        this.host : this;
      if (ref_node) {
        insertBefore$1(container, node, ref_node);
      } else {
        appendChild$1(container, node);
      }
    }
...
var Distributor = (function () {
  ...
  anonymous.prototype.distributePool = function distributePool (node, pool) {
    ...
    for (var i$1=0; i$1 < pool.length; i$1++) {
      ...
      if (p$1) {
        ...
        var parent$1 = parentNode(p$1);
        if (parent$1) {
          removeChild$1(parent$1, p$1);
        }
      }
    }
    return dirtyRoots;
  ...
  anonymous.prototype.distributeInsertionPoint = function distributeInsertionPoint (insertionPoint, pool) {
    ...
    if (!anyDistributed) {
      ...
      for (var j = 0, node$1; j < children$$1.length; j++) {
        node$1 = children$$1[j];
  ...
  _updateChildNodes: function _updateChildNodes(container, children$$1) {
    ...
    for (var i$1=0, s$1, next; (i$1<splices.length) && (s$1=splices[i$1]); i$1++) { //eslint-disable-line no-redeclare
      ...
      for (var j$1=s$1.index, n$1; j$1 < s$1.index + s$1.addedCount; j$1++) {
        n$1 = children$$1[j$1];
        insertBefore$1(container, n$1, next);
