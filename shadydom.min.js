...
a=P.children(this);a.item=function(b){return a[b]};for(var b=fa(a),c=b.next();!c.done;c=b.next()){c=c.value;var d=c.getAttribute("id")||c.getAttribute("name");d&&(a[d]=c)}return a},configurable:!0},innerHTML:{get:function(){return x(this)?Da("template"===this.localName?this.content:this):P.innerHTML(this)},set:function(a){var b="template"===this.localName?this.content:this;ab(b);var c=this.localName;c&&"template"!==c||(c="div");c=cb.createElement(c);for(bb?J.J.innerHTML.set.call(c,a):c.innerHTML=
