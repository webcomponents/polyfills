...
function Z(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],f=Object.getOwnPropertyDescriptor(b,e);f.value?a[e]=f.value:Object.defineProperty(a,e,f)}};if(v.I){window.ShadyDOM={inUse:v.I,patch:function(a){nb(a);mb(a);return a},isShadyRoot:y,enqueue:wa,flush:F,settings:v,filterMutations:Ub,observeChildren:Sb,unobserveChildren:Tb,nativeMethods:Q,nativeTree:P};window.Event=jc;window.CustomEvent=kc;window.MouseEvent=lc;ic();var xc=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Z(U.prototype,wc);Z(window.Node.prototype,oc);Z(window.Window.prototype,nc);Z(window.Text.prototype,pc);Z(window.DocumentFragment.prototype,qc);Z(window.Element.prototype,
sc);Z(window.Document.prototype,tc);window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,rc);Z(xc.prototype,vc);v.f&&(S(window.Node.prototype),S(window.Text.prototype),S(window.DocumentFragment.prototype),S(window.Element.prototype),S(xc.prototype),S(window.Document.prototype),window.HTMLSlotElement&&S(window.HTMLSlotElement.prototype));lb();window.ShadowRoot=U};}).call(this);
