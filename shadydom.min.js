...
(function () {
  ...
  */
  ...
  var ensureOutsideAccessors = settings.hasDescriptors ? function () {} : function (element) {
  ...
  var ensureInsideAccessors = settings.hasDescriptors ? function () {} : function (element) {
  ...
  */
  ...
  function insertBefore$1(parent, node, ref_node) {
    if (ref_node) {
      var _p2 = getProperty(ref_node, 'parentNode');
      if (_p2 !== undefined && _p2 !== parent) {
  ...
  */
  ...
  if (settings.inUse) {
    ...
    if (window.HTMLSlotElement) {
      extendGlobal(HTMLSlotElement.prototype, Slot);
    }
