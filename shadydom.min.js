...
a=P.children(this);a.item=function(b){return a[b]};for(var b=fa(a),c=b.next();!c.done;c=b.next()){c=c.value;var d=c.getAttribute("id")||c.getAttribute("name");d&&(a[d]=c)}return a},configurable:!0},innerHTML:{get:function(){return x(this)?Da("template"===this.localName?this.content:this):P.innerHTML(this)},set:function(a){var b="template"===this.localName?this.content:this;ab(b);var c=this.localName;c&&"template"!==c||(c="div");c=this.namespaceURI&&this.namespaceURI!==cb.namespaceURI?cb.createElementNS(this.namespaceURI,
c):cb.createElement(c);for(bb?J.J.innerHTML.set.call(c,a):c.innerHTML=a;c.firstChild;)b.appendChild(c.firstChild)},configurable:!0}},jb={shadowRoot:{get:function(){var a=u(this);return a&&a.K||null},configurable:!0}},kb={activeElement:{get:function(){var a=fb&&fb.get?fb.get.call(document):v.f?void 0:document.activeElement;if(a&&a.nodeType){var b=!!y(this);if(this===document||b&&this.host!==a&&Q.contains.call(this.host,a)){for(b=z(a);b&&b!==this;)a=b.host,b=z(a);a=this===document?b?null:a:b===this?
a:null}else a=null}else a=null;return a},set:function(){},configurable:!0}};function R(a,b,c){for(var d in b){var e=Object.getOwnPropertyDescriptor(a,d);e&&e.configurable||!e&&c?Object.defineProperty(a,d,b[d]):c&&console.warn("Could not define",d,"on",a)}}function S(a){R(a,gb);R(a,hb);R(a,ib);R(a,kb)}
