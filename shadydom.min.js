...
a=P.children(this);a.item=function(b){return a[b]};return a},configurable:!0},innerHTML:{get:function(){return x(this)?Da("template"===this.localName?this.content:this):P.innerHTML(this)},set:function(a){var b="template"===this.localName?this.content:this;ab(b);var c=this.localName;c&&"template"!==c||(c="div");c=this.namespaceURI&&this.namespaceURI!==cb.namespaceURI?cb.createElementNS(this.namespaceURI,c):cb.createElement(c);for(bb?J.J.innerHTML.set.call(c,a):c.innerHTML=a;c.firstChild;)b.appendChild(c.firstChild)},
...
function V(a){a.o||(a.o=!0,wa(function(){return vb(a)}))}function vb(a){for(var b;a;){a.o&&(b=a);a:{var c=a;a=c.host.getRootNode();if(y(a))for(var d=c.host.childNodes,e=0;e<d.length;e++)if(c=d[e],"slot"==c.localName)break a;a=void 0}}b&&b._renderRoot()}
...
var oc={addEventListener:fc.bind(window),removeEventListener:hc.bind(window)},pc={addEventListener:fc,removeEventListener:hc,appendChild:function(a){return Eb(this,a)},insertBefore:function(a,b){return Eb(this,a,b)},removeChild:function(a){return Fb(this,a)},replaceChild:function(a,b){Eb(this,a,b);Fb(this,b);return a},cloneNode:function(a){if("template"==this.localName)var b=Q.cloneNode.call(this,a);else if(b=Q.cloneNode.call(this,!1),a&&b.nodeType!==Node.ATTRIBUTE_NODE){a=this.childNodes;for(var c=
0,d;c<a.length;c++)d=a[c].cloneNode(!0),b.appendChild(d)}return b},getRootNode:function(){return Mb(this)},contains:function(a){return ua(this,a)},dispatchEvent:function(a){F();return Q.dispatchEvent.call(this,a)}};
...
var qc={get assignedSlot(){return nc(this)}},rc={querySelector:function(a){return W(this,function(b){return na.call(b,a)},function(a){return!!a})[0]||null},querySelectorAll:function(a,b){if(b){b=Array.prototype.slice.call(Q.querySelectorAll.call(this,a));var c=this.getRootNode();return b.filter(function(a){return a.getRootNode()==c})}return W(this,function(b){return na.call(b,a)})}},sc={assignedNodes:function(a){if("slot"===this.localName){var b=this.getRootNode();y(b)&&vb(b);return(b=u(this))?(a&&
a.flatten?b.g:b.assignedNodes)||[]:[]}}},tc=oa({setAttribute:function(a,b){Ob(this,a,b)},removeAttribute:function(a){Q.removeAttribute.call(this,a);Kb(this,a)},attachShadow:function(a){if(!this)throw"Must provide a host.";if(!a)throw"Not enough arguments.";return new U(tb,this,a)},get slot(){return this.getAttribute("slot")},set slot(a){Ob(this,"slot",a)},get assignedSlot(){return nc(this)}},rc,sc);Object.defineProperties(tc,jb);
