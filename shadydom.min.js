...
function Ca(a,b){"template"===a.localName&&(a=a.content);for(var c="",d=b?b(a):a.childNodes,e=0,f=d.length,g;e<f&&(g=d[e]);e++){a:{var h=g;var k=a;var l=b;switch(h.nodeType){case Node.ELEMENT_NODE:for(var n=h.localName,q="<"+n,D=h.attributes,M=0;k=D[M];M++)q+=" "+k.name+'="'+k.value.replace(wa,ya)+'"';q+=">";h=Aa[n]?q:q+Ca(h,l)+"</"+n+">";break a;case Node.TEXT_NODE:h=h.data;h=k&&Ba[k.localName]?h:h.replace(xa,ya);break a;case Node.COMMENT_NODE:h="\x3c!--"+h.data+"--\x3e";break a;default:throw window.console.error(h),
Error("not implemented");}}c+=h}return c};var H=document.createTreeWalker(document,NodeFilter.SHOW_ALL,null,!1),I=document.createTreeWalker(document,NodeFilter.SHOW_ELEMENT,null,!1);function Da(a){var b=[];H.currentNode=a;for(a=H.firstChild();a;)b.push(a),a=H.nextSibling();return b}
...
(g=b.querySelectorAll("slot"));f=g&&g.length?g:void 0}f&&(g=e,d=f,g.c=g.c||[],g.a=g.a||[],g.b=g.b||{},g.c.push.apply(g.c,d instanceof Array?d:ha(fa(d))))}("slot"===a.localName||f)&&(e=e||z(a))&&V(e);if(x(a)){e=c;nb(a);f=t(a);void 0!==f.firstChild&&(f.childNodes=null);if(b.nodeType===Node.DOCUMENT_FRAGMENT_NODE){f=b.childNodes;for(g=0;g<f.length;g++)pb(f[g],a,e);e=t(b);f=void 0!==e.firstChild?null:void 0;e.firstChild=e.lastChild=f;e.childNodes=f}else pb(b,a,e);e=u(a);if(Gb(a)){V(e.root);var h=!0}else e.root&&
(h=!0)}h||(h=y(a)?a.host:a,c?(c=Hb(c),Q.insertBefore.call(h,b,c)):Q.appendChild.call(h,b));Ib(a,b);return b}
...
(k=!0);if(c.a){wb(c);f=c.b;for(S in f)for(g=f[S],h=0;h<g.length;h++){var l=g[h];if(ta(b,l)){g.splice(h,1);var n=c.a.indexOf(l);0<=n&&c.a.splice(n,1);h--;n=u(l);if(l=n.g)for(var q=0;q<l.length;q++){var D=l[q],M=rb(D);M&&Q.removeChild.call(M,D)}n.g=[];n.assignedNodes=[];n=!0}}var S=n}else S=void 0;(S||e)&&V(c)}k||(k=y(a)?a.host:a,(!d.root&&"slot"!==b.localName||k===Db(b))&&Q.removeChild.call(k,b));Ib(a,null,b);return b}
...
function Wb(a,b){var c=[],d=a;for(a=a===window?window:a.getRootNode();d;)c.push(d),d=d.assignedSlot?d.assignedSlot:d.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&d.host&&(b||d!==a)?d.host:d.parentNode;c[c.length-1]===document&&c.push(window);return c}function Xb(a,b){if(!y)return a;a=Wb(a,!0);for(var c=0,d,e,f,g;c<b.length;c++)if(d=b[c],f=d===window?window:d.getRootNode(),f!==e&&(g=a.indexOf(f),e=f),!y(f)||-1<g)return d}
