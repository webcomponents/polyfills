...
var twiddle$$module$$src$utils=document.createTextNode(""),content$$module$$src$utils=0,queue$$module$$src$utils=[];(new MutationObserver(function(){for(;queue$$module$$src$utils.length;)queue$$module$$src$utils.shift()()})).observe(twiddle$$module$$src$utils,{characterData:!0});function microtask$$module$$src$utils(a){queue$$module$$src$utils.push(a);twiddle$$module$$src$utils.textContent=content$$module$$src$utils++}module$$src$utils.settings=settings$$module$$src$utils;
module$$src$utils.isShadyRoot=isShadyRoot$$module$$src$utils;module$$src$utils.ownerShadyRootForNode=ownerShadyRootForNode$$module$$src$utils;module$$src$utils.matchesSelector=matchesSelector$$module$$src$utils;module$$src$utils.extend=extend$$module$$src$utils;module$$src$utils.extendAll=extendAll$$module$$src$utils;module$$src$utils.mixin=mixin$$module$$src$utils;module$$src$utils.patchPrototype=patchPrototype$$module$$src$utils;module$$src$utils.microtask=microtask$$module$$src$utils;var module$$src$flush={},customElements$$module$$src$flush=window.customElements,flushList$$module$$src$flush=[],scheduled$$module$$src$flush,flushCount$$module$$src$flush=0,flushMax$$module$$src$flush=100;function enqueue$$module$$src$flush(a){scheduled$$module$$src$flush||(scheduled$$module$$src$flush=!0,module$$src$utils.microtask(flush$$module$$src$flush));flushList$$module$$src$flush.push(a)}
