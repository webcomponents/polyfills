...
var ShadyMixin = {
  ...
  _updateChildNodes: function _updateChildNodes(container, children) {
    var composed = isShadyRoot(container) ?
...
Node.prototype.__nativeProps = {};

Node.prototype.__nativeProps.childNodes =
    ...
    get: function get() {
      ...
      if (hasLogical(this, 'firstChild')) {
        if (!this.__shady.childNodes) {
          ...
          for (var n=this.firstChild; n; n=this.nextSibling) {
...
var Mixins$1 = {
  ...
  Element: ElementMixin$1,

  // Note: activeElement cannot be patched on document!
  Document: extendAll({},
    UnderActiveElementMixin$1)
...
if (settings.inUse) {
  ...
  for (var p in Mixins.Default) {
    var method = Mixins.Default[p];
