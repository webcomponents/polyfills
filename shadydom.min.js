...
var appendChild$1$1 = Element.prototype.appendChild;
var insertBefore$1$1 = Element.prototype.insertBefore;
var removeChild$1$1 = Element.prototype.removeChild;
var setAttribute = Element.prototype.setAttribute;
var removeAttribute$1$1 = Element.prototype.removeAttribute;

var nativeMethods = {
  appendChild: function appendChild$1(parent, child) {
    return appendChild$1$1.call(parent, child);
  },
  insertBefore: function insertBefore$1(parent, child, ref_node) {
    return insertBefore$1$1.call(parent, child, ref_node);
  },
  removeChild: function removeChild$1(parent, child) {
    return removeChild$1$1.call(parent, child);
  },
  setAttribute: function setAttribute$1(node, name, value) {
    setAttribute.call(node, name, value);
  },
  removeAttribute: function removeAttribute$1(node, name) {
    removeAttribute$1$1.call(node, name);
  }
};
...
var activeElementDesc = Object.getOwnPropertyDescriptor(Document.prototype, 'activeElement');
...
var mixinImpl = {
  ...
  removeNode: function removeNode(node) {
    ...
    var logicalParent = hasProperty(node, 'parentNode') &&
...
var NodeMixin = {
  ...
  insertBefore: function insertBefore(node, ref_node) {
    ...
    if (node.nodeType !== Node.DOCUMENT_FRAGMENT_NODE) {
      var parent = getProperty(node, 'parentNode');
  ...
  anonymous.prototype.distributePool = function distributePool (node, pool) {
    ...
    for (var i$1=0; i$1 < pool.length; i$1++) {
      ...
      if (p$1) {
        ...
        if (parent$1) {
          nativeMethods.removeChild(parent$1, p$1);
        }
      }
    }
    return dirtyRoots;
...
var ShadyMixin = {
  ...
  updateInsertionPoints: function updateInsertionPoints() {
    ...
    for (var i$1=0, c$1; i$1 < i$.length; i$1++) {
      ...
      recordChildNodes(c$1);
      recordChildNodes(c$1.parentNode);
    }
  },
  ...
  _updateChildNodes: function _updateChildNodes(container, children) {
    ...
    for (var i$1=0, s$1, next; (i$1<splices.length) && (s$1=splices[i$1]); i$1++) { //eslint-disable-line no-redeclare
      ...
      for (var j$1=s$1.index, n$1; j$1 < s$1.index + s$1.addedCount; j$1++) {
        n$1 = children[j$1];
        nativeMethods.insertBefore(container, n$1, next);
