...
b)};module$$src$ShadyDOM$array_splice.calculateSplices=calculateSplices$$module$$src$ShadyDOM$array_splice;var module$$src$ShadyDOM$utils={},settings$$module$$src$ShadyDOM$utils=window.ShadyDOM||{};settings$$module$$src$ShadyDOM$utils.inUse=settings$$module$$src$ShadyDOM$utils.dom||!Element.prototype.attachShadow;function isShadyRoot$$module$$src$ShadyDOM$utils(a){return"ShadyRoot"===a.__localName}
