...
b.v++;e++;break;case 3:b||(b=t(e,0)),b.l.push(c[f]),f++}b&&k.push(b);return k}function ia(a,b){return a===b};function ja(){this.N=this.root=null;this.A=!1;this.h=this.s=this.G=this.assignedSlot=this.assignedNodes=this.i=null;this.childNodes=this.nextSibling=this.previousSibling=this.lastChild=this.firstChild=this.parentNode=this.j=void 0;this.R=this.J=!1;this.o={}}ja.prototype.toJSON=function(){return{}};function u(a){a.D||(a.D=new ja);return a.D}function v(a){return a&&a.D};var w=window.ShadyDOM||{};w.Y=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var ka=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");w.g=!!(ka&&ka.configurable&&ka.get);w.H=w.force||!w.Y;var la=navigator.userAgent.match("Trident"),ma=navigator.userAgent.match("Edge");void 0===w.O&&(w.O=w.g&&(la||ma));function x(a){return(a=v(a))&&void 0!==a.firstChild}function y(a){return"ShadyRoot"===a.U}function z(a){a=a.getRootNode();if(y(a))return a}
...
if(window.customElements&&w.H){var V=new Map;T=function(){var a=Array.from(V);V.clear();a=r(a);for(var b=a.next();!b.done;b=a.next()){b=r(b.value);var c=b.next().value;b.next().value?c.connectedCallback():c.disconnectedCallback()}};S&&document.addEventListener("readystatechange",function(){S=!1;T()},{once:!0});var Gb=function(a,b,c){var d=0,e="__isConnected"+d++;if(b||c)a.prototype.connectedCallback=function(){S?V.set(this,!0):this[e]||(this[e]=!0,b&&b.call(this))},a.prototype.disconnectedCallback=
function(){S?this.isConnected||V.set(this,!1):this[e]&&(this[e]=!1,c&&c.call(this))};return a},Hb=window.customElements.define;window.customElements.define=function(a,b){var c=b.prototype.connectedCallback,d=b.prototype.disconnectedCallback;Hb.call(window.customElements,a,Gb(b,c,d));b.prototype.connectedCallback=c;b.prototype.disconnectedCallback=d}};var Ib=M.parentNode;
...
function Y(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],f=Object.getOwnPropertyDescriptor(b,e);f.value?a[e]=f.value:Object.defineProperty(a,e,f)}};if(w.H){window.ShadyDOM={inUse:w.H,patch:function(a){qb(a);pb(a);return a},isShadyRoot:y,enqueue:za,flush:C,settings:w,filterMutations:ac,observeChildren:Zb,unobserveChildren:$b,nativeMethods:N,nativeTree:M,deferNativeCustomElementsConnection:w.deferNativeCustomElementsConnection};uc();var Ic=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Y(R.prototype,Hc);Y(window.Node.prototype,xc);Y(window.Window.prototype,wc);Y(window.Text.prototype,yc);Y(window.DocumentFragment.prototype,
zc);Y(window.Element.prototype,Bc);Y(window.Document.prototype,Cc);window.HTMLSlotElement&&Y(window.HTMLSlotElement.prototype,Ac);Y(Ic.prototype,Ec);w.g&&(P(window.Node.prototype),P(window.Text.prototype),P(window.DocumentFragment.prototype),P(window.Element.prototype),P(Ic.prototype),P(window.Document.prototype),window.HTMLSlotElement&&P(window.HTMLSlotElement.prototype));ob();window.ShadowRoot=R};}).call(this);
