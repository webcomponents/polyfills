...
b.prototype.values=function(){return this.map_.values()};b.prototype[Symbol.iterator]=b.prototype.values;b.prototype.forEach=function(a,b){var e=this;this.map_.forEach(function(f){return a.call(b,f,f,e)})};return b},"es6-impl","es3");
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,c,d){$jscomp.initSymbolIterator();c=null!=c?c:function(a){return a};var e=[],f=a[Symbol.iterator];if("function"==typeof f)for(a=f.call(a);!(f=a.next()).done;)e.push(c.call(d,f.value));else for(var f=a.length,g=0;g<f;g++)e.push(c.call(d,a[g]));return e}},"es6-impl","es3");var module$$src$array_splice={};function newSplice$$module$$src$array_splice(a,b,c){return{index:a,removed:b,addedCount:c}}
...
function extendAll$$module$$src$utils(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];for(d=0;d<c.length;d++)extend$$module$$src$utils(a,c[d]);return a}function mixin$$module$$src$utils(a,b){for(var c in b)a[c]=b[c];return a}function patchPrototype$$module$$src$utils(a,b){var c=Object.getPrototypeOf(a);if(!c.hasOwnProperty("__patchProto")){var d=Object.create(c);d.__sourceProto=c;extend$$module$$src$utils(d,b);c.__patchProto=d}a.__proto__=c.__patchProto}var promish$$module$$src$utils;
if(window.Promise)promish$$module$$src$utils=Promise.resolve();else{var twiddle=document.createTextNode(""),content=0;promish$$module$$src$utils={then:function(a){var b=new MutationObserver(function(){b.disconnect();a()});b.observe(twiddle,{characterData:!0});twiddle.textContent=content++}}}module$$src$utils.settings=settings$$module$$src$utils;module$$src$utils.isShadyRoot=isShadyRoot$$module$$src$utils;module$$src$utils.ownerShadyRootForNode=ownerShadyRootForNode$$module$$src$utils;
module$$src$utils.matchesSelector=matchesSelector$$module$$src$utils;module$$src$utils.extend=extend$$module$$src$utils;module$$src$utils.extendAll=extendAll$$module$$src$utils;module$$src$utils.mixin=mixin$$module$$src$utils;module$$src$utils.patchPrototype=patchPrototype$$module$$src$utils;module$$src$utils.promish=promish$$module$$src$utils;var module$$src$flush={},customElements$$module$$src$flush=window.customElements,flushList$$module$$src$flush=[],scheduled$$module$$src$flush,flushCount$$module$$src$flush=0,flushMax$$module$$src$flush=100;function enqueue$$module$$src$flush(a){scheduled$$module$$src$flush||(scheduled$$module$$src$flush=!0,module$$src$utils.promish.then(flush$$module$$src$flush));flushList$$module$$src$flush.push(a)}
...
module$$src$attach_shadow.ShadyRoot=ShadyRoot$$module$$src$attach_shadow;module$$src$attach_shadow.attachShadow=attachShadow$$module$$src$attach_shadow;var module$$src$observe_changes={},AsyncObserver$$module$$src$observe_changes=function(){this._scheduled=!1;this.addedNodes=[];this.removedNodes=[];this.callbacks=new Set};AsyncObserver$$module$$src$observe_changes.prototype.schedule=function(){var a=this;this._scheduled||(this._scheduled=!0,module$$src$utils.promish.then(function(){a.flush()}))};AsyncObserver$$module$$src$observe_changes.prototype.flush=function(){if(this._scheduled){this._scheduled=!1;var a=this.takeRecords();a.length&&this.callbacks.forEach(function(b){b(a)})}};
...
function activateFocusEventOverrides$$module$$src$patch_events(){for(var a in nonBubblingEventsToRetarget$$module$$src$patch_events)window.addEventListener(a,function(a){a.__target||(a.__target=a.target,a.__relatedTarget=a.relatedTarget,module$$src$utils.patchPrototype(a,eventMixin$$module$$src$patch_events),retargetNonBubblingEvent$$module$$src$patch_events(a),a.stopImmediatePropagation())},!0)}
