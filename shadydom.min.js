...
Error("not implemented");}}d+=f}return d};var I={},J=document.createTreeWalker(document,NodeFilter.SHOW_ALL,null,!1),K=document.createTreeWalker(document,NodeFilter.SHOW_ELEMENT,null,!1);function oa(a){var b=[];J.currentNode=a;for(a=J.firstChild();a;)b.push(a),a=J.nextSibling();return b}I.parentNode=function(a){J.currentNode=a;return J.parentNode()};I.firstChild=function(a){J.currentNode=a;return J.firstChild()};I.lastChild=function(a){J.currentNode=a;return J.lastChild()};I.previousSibling=function(a){J.currentNode=a;return J.previousSibling()};
I.nextSibling=function(a){J.currentNode=a;return J.nextSibling()};I.childNodes=oa;I.parentElement=function(a){K.currentNode=a;return K.parentNode()};I.firstElementChild=function(a){K.currentNode=a;return K.firstChild()};I.lastElementChild=function(a){K.currentNode=a;return K.lastChild()};I.previousElementSibling=function(a){K.currentNode=a;return K.previousSibling()};I.nextElementSibling=function(a){K.currentNode=a;return K.nextSibling()};
...
b.b.push({node:this,type:a,capture:c,once:e,passive:h,W:g});jb[a]?(this.f=this.f||{},this.f[a]=this.f[a]||{capture:[],bubble:[]},this.f[a][c?"capture":"bubble"].push(g)):U.addEventListener.call(this,a,g,d)}},removeEventListener:function(a,b,d){if(b){var c,e,h;"object"===typeof d?(c=!!d.capture,e=!!d.once,h=!!d.passive):(c=!!d,h=e=!1);var g=void 0;if(b.b)for(var f=0;f<b.b.length;f++)if(b.b[f].node===this&&b.b[f].type===a&&b.b[f].capture===c&&b.b[f].once===e&&b.b[f].passive===h){g=b.b.splice(f,1)[0].W;
b.b.length||(b.b=void 0);break}U.removeEventListener.call(this,a,g||b,d);g&&jb[a]&&this.f&&this.f[a]&&(a=this.f[a][c?"capture":"bubble"],g=a.indexOf(g),-1<g&&a.splice(g,1))}},appendChild:function(a){return Ya(this,a)},insertBefore:function(a,b){return Ya(this,a,b)},removeChild:function(a){if(a.parentNode!==this)throw Error("The node to be removed is not a child of this node: "+a);if(!Oa(a)){var b=u(this)?this.host:this,d=I.parentNode(a);b===d&&U.removeChild.call(b,a)}Ra(this,null,a);return a},replaceChild:function(a,
