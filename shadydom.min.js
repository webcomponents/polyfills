...
b.o++;e++;break;case 3:b||(b=r(e,0)),b.j.push(c[f]),f++}b&&k.push(b);return k}function ja(a,b){return a===b};function ka(){this.M=this.root=null;this.u=!1;this.g=this.l=this.G=this.assignedSlot=this.assignedNodes=this.h=null;this.childNodes=this.nextSibling=this.previousSibling=this.lastChild=this.firstChild=this.parentNode=this.i=void 0;this.P=this.I=!1}ka.prototype.toJSON=function(){return{}};function t(a){a.D||(a.D=new ka);return a.D}function u(a){return a&&a.D};var v=window.ShadyDOM||{};v.X=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var w=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");v.f=!!(w&&w.configurable&&w.get);v.K=v.force||!v.X;var la=navigator.userAgent.match("Trident"),ma=navigator.userAgent.match("Edge");void 0===v.N&&(v.N=v.f&&(la||ma));function x(a){return(a=u(a))&&void 0!==a.firstChild}function y(a){return"ShadyRoot"===a.T}function z(a){a=a.getRootNode();if(y(a))return a}
...
J.firstElementChild=function(a){switch(a.nodeType){case Node.DOCUMENT_FRAGMENT_NODE:return M.firstElementChild.get.call(a);case Node.DOCUMENT_NODE:return O.firstElementChild.get.call(a);default:return L.firstElementChild.get.call(a)}};J.lastElementChild=function(a){switch(a.nodeType){case Node.DOCUMENT_FRAGMENT_NODE:return M.lastElementChild.get.call(a);case Node.DOCUMENT_NODE:return O.lastElementChild.get.call(a);default:return L.lastElementChild.get.call(a)}};var P=v.N?J:G;var Q={},Ha=Element.prototype.insertBefore,Ia=Element.prototype.replaceChild,Ja=Element.prototype.removeChild,Ka=Element.prototype.setAttribute,La=Element.prototype.removeAttribute,Ma=Element.prototype.cloneNode,Na=Document.prototype.importNode,Oa=Element.prototype.addEventListener,Pa=Element.prototype.removeEventListener,Qa=Window.prototype.addEventListener,Ra=Window.prototype.removeEventListener,Sa=Element.prototype.dispatchEvent,Ta=Node.prototype.contains||HTMLElement.prototype.contains,Ua=Document.prototype.getElementById,
Va=Element.prototype.querySelector,Wa=DocumentFragment.prototype.querySelector,Xa=Document.prototype.querySelector,Ya=Element.prototype.querySelectorAll,Za=DocumentFragment.prototype.querySelectorAll,$a=Document.prototype.querySelectorAll;Q.appendChild=Element.prototype.appendChild;Q.insertBefore=Ha;Q.replaceChild=Ia;Q.removeChild=Ja;Q.setAttribute=Ka;Q.removeAttribute=La;Q.cloneNode=Ma;Q.importNode=Na;Q.addEventListener=Oa;Q.removeEventListener=Pa;Q.Y=Qa;Q.Z=Ra;Q.dispatchEvent=Sa;Q.contains=Ta;
Q.getElementById=Ua;Q.ea=Va;Q.ha=Wa;Q.ca=Xa;Q.querySelector=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return Va.call(this,a);case Node.DOCUMENT_NODE:return Xa.call(this,a);default:return Wa.call(this,a)}};Q.fa=Ya;Q.ia=Za;Q.da=$a;Q.querySelectorAll=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return Ya.call(this,a);case Node.DOCUMENT_NODE:return $a.call(this,a);default:return Za.call(this,a)}};function ab(a){for(;a.firstChild;)a.removeChild(a.firstChild)}
...
a.push(d.textContent);return a.join("")}return P.textContent(this)},set:function(a){if("undefined"===typeof a||null===a)a="";switch(this.nodeType){case Node.ELEMENT_NODE:case Node.DOCUMENT_FRAGMENT_NODE:if(!x(this)&&bb){var b=this.firstChild;(b!=this.lastChild||b&&b.nodeType!=Node.TEXT_NODE)&&ab(this);J.L.textContent.set.call(this,a)}else ab(this),(0<a.length||this.nodeType===Node.ELEMENT_NODE)&&this.appendChild(document.createTextNode(a));break;default:this.nodeValue=a}},configurable:!0},firstElementChild:{get:function(){var a=
...
a=P.children(this);a.item=function(b){return a[b]};return a},configurable:!0},innerHTML:{get:function(){return x(this)?Da("template"===this.localName?this.content:this):P.innerHTML(this)},set:function(a){var b="template"===this.localName?this.content:this;ab(b);var c=this.localName;c&&"template"!==c||(c="div");c=cb.createElement(c);for(bb?J.L.innerHTML.set.call(c,a):c.innerHTML=a;c.firstChild;)b.appendChild(c.firstChild)},configurable:!0}},jb={shadowRoot:{get:function(){var a=u(this);return a&&a.M||
...
function Bb(a){var b=a.name||a.getAttribute("name")||"__catchall";return a.R=b}function Cb(a){return a.sort(function(a,c){a=ub(a);for(var b=ub(c),e=0;e<a.length;e++){c=a[e];var f=b[e];if(c!==f)return a=Array.from(c.parentNode.childNodes),a.indexOf(c)-a.indexOf(f)}})}function yb(a){wb(a);return!(!a.a||!a.a.length)};var Db=P.parentNode;
...
function Kb(a,b){if("slot"===b)a=a.parentNode,Gb(a)&&V(u(a).root);else if("slot"===a.localName&&"name"===b&&(b=z(a))){if(b.a){var c=a.R,d=Bb(a);if(d!==c){c=b.b[c];var e=c.indexOf(a);0<=e&&c.splice(e,1);c=b.b[d]||(b.b[d]=[]);c.push(a);1<c.length&&(b.b[d]=Cb(c))}}V(b)}}function Ib(a,b,c){if(a=(a=u(a))&&a.h)b&&a.addedNodes.push(b),c&&a.removedNodes.push(c),Lb(a)}
...
function Sb(a,b){var c=t(a);c.h||(c.h=new Qb);c.h.s.add(b);var d=c.h;return{S:b,V:d,U:a,takeRecords:function(){return d.takeRecords()}}}function Tb(a){var b=a&&a.V;b&&(b.s.delete(a.S),b.s.size||(t(a.U).h=null))}
...
var Yb={get composed(){!1!==this.isTrusted&&void 0===this.v&&(this.v=Vb[this.type]);return this.v||!1},composedPath:function(){this.H||(this.H=Wb(this.__target,this.composed));return this.H},get target(){return Xb(this.currentTarget,this.composedPath())},get relatedTarget(){if(!this.C)return null;this.J||(this.J=Wb(this.C,!0));return Xb(this.currentTarget,this.J)},stopPropagation:function(){Event.prototype.stopPropagation.call(this);this.B=!0},stopImmediatePropagation:function(){Event.prototype.stopImmediatePropagation.call(this);
this.B=this.O=!0}};function Zb(a){function b(b,d){b=new a(b,d);b.v=d&&!!d.composed;return b}oa(b,a);b.prototype=a.prototype;return b}var $b={focus:!0,blur:!0};function ac(a){return a.__target!==a.target||a.C!==a.relatedTarget}function bc(a,b,c){if(c=b.__handlers&&b.__handlers[a.type]&&b.__handlers[a.type][c])for(var d=0,e;(e=c[d])&&(!ac(a)||a.target!==a.relatedTarget)&&(e.call(b,a),!a.O);d++);}
function cc(a){var b=a.composedPath();Object.defineProperty(a,"currentTarget",{get:function(){return d},configurable:!0});for(var c=b.length-1;0<=c;c--){var d=b[c];bc(a,d,"capture");if(a.B)return}Object.defineProperty(a,"eventPhase",{get:function(){return Event.AT_TARGET}});var e;for(c=0;c<b.length;c++){d=b[c];var f=u(d);f=f&&f.root;if(0===c||f&&f===e)if(bc(a,d,"bubble"),d!==window&&(e=d.getRootNode()),a.B)break}}
...
function ec(a,b,c){if(b){var d=typeof b;if("function"===d||"object"===d)if("object"!==d||b.handleEvent&&"function"===typeof b.handleEvent){if(c&&"object"===typeof c){var e=!!c.capture;var f=!!c.once;var g=!!c.passive}else e=!!c,g=f=!1;var h=c&&c.F||this,k=b[Y];if(k){if(-1<dc(k,h,a,e,f,g))return}else b[Y]=[];k=function(e){f&&this.removeEventListener(a,b,c);e.__target||fc(e);if(h!==this){var g=Object.getOwnPropertyDescriptor(e,"currentTarget");Object.defineProperty(e,"currentTarget",{get:function(){return h},
configurable:!0})}if(e.composed||-1<e.composedPath().indexOf(h))if(ac(e)&&e.target===e.relatedTarget)e.eventPhase===Event.BUBBLING_PHASE&&e.stopImmediatePropagation();else if(e.eventPhase===Event.CAPTURING_PHASE||e.bubbles||e.target===h||h instanceof Window){var k="function"===d?b.call(h,e):b.handleEvent&&b.handleEvent(e);h!==this&&(g?(Object.defineProperty(e,"currentTarget",g),g=null):delete e.currentTarget);return k}};b[Y].push({node:h,type:a,capture:e,once:f,passive:g,$:k});$b[a]?(this.__handlers=
this.__handlers||{},this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]},this.__handlers[a][e?"capture":"bubble"].push(k)):(this instanceof Window?Q.Y:Q.addEventListener).call(this,a,k,c)}}}
function gc(a,b,c){if(b){if(c&&"object"===typeof c){var d=!!c.capture;var e=!!c.once;var f=!!c.passive}else d=!!c,f=e=!1;var g=c&&c.F||this,h=void 0;var k=null;try{k=b[Y]}catch(l){}k&&(e=dc(k,g,a,d,e,f),-1<e&&(h=k.splice(e,1)[0].$,k.length||(b[Y]=void 0)));(this instanceof Window?Q.Z:Q.removeEventListener).call(this,a,h||b,c);h&&$b[a]&&this.__handlers&&this.__handlers[a]&&(a=this.__handlers[a][d?"capture":"bubble"],h=a.indexOf(h),-1<h&&a.splice(h,1))}}
function hc(){for(var a in $b)window.addEventListener(a,function(a){a.__target||(fc(a),cc(a))},!0)}function fc(a){a.__target=a.target;a.C=a.relatedTarget;if(v.f){var b=Object.getPrototypeOf(a);if(!b.hasOwnProperty("__patchProto")){var c=Object.create(b);c.aa=b;B(c,Yb);b.__patchProto=c}a.__proto__=b.__patchProto}else B(a,Yb)}var ic=Zb(window.Event),jc=Zb(window.CustomEvent),kc=Zb(window.MouseEvent);function lc(a){var b=a.getRootNode();y(b)&&vb(b);return(a=u(a))&&a.assignedSlot||null}
...
var oc={get assignedSlot(){return lc(this)}},pc={querySelector:function(a){return W(this,function(b){return na.call(b,a)},function(a){return!!a})[0]||null},querySelectorAll:function(a,b){if(b){b=Array.prototype.slice.call(Q.querySelectorAll.call(this,a));var c=this.getRootNode();return b.filter(function(a){return a.getRootNode()==c})}return W(this,function(b){return na.call(b,a)})}},qc={assignedNodes:function(a){if("slot"===this.localName){var b=this.getRootNode();y(b)&&vb(b);return(b=u(this))?(a&&
