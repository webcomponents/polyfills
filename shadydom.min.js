...
var saveChildNodes$1$1 = function(node) {
  if (!hasLogical(node, 'firstChild')) {
    ...
    var c$ = node.__shady.childNodes = Array.from(getNative(node, 'childNodes'));
...
var patchProto = function(proto, mixin$$1) {
...
var getComposedInnerHTML = function(node) {
  if (hasLogical(node, 'firstChild')) {
    return getInnerHTML(node, function (n) { return getNative(n, 'childNodes'); });
  } else {
  ...
  anonymous.prototype.distributePool = function distributePool (node, pool) {
    ...
    for (var i$1=0; i$1 < pool.length; i$1++) {
      ...
      if (p$1) {
        ...
        var parent$1 = getNative(p$1, 'parentNode');
        if (parent$1) {
...
if (settings.inUse) {
  ...
  patchProto(Document.prototype, Mixins.Element);
  if (HTMLSlotElement) {
