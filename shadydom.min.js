...
b.v++;e++;break;case 3:b||(b=t(e,0)),b.l.push(c[f]),f++}b&&k.push(b);return k}function ia(a,b){return a===b};function ja(){this.N=this.root=null;this.A=!1;this.h=this.s=this.G=this.assignedSlot=this.assignedNodes=this.i=null;this.childNodes=this.nextSibling=this.previousSibling=this.lastChild=this.firstChild=this.parentNode=this.j=void 0;this.R=this.I=!1;this.o={}}ja.prototype.toJSON=function(){return{}};function u(a){a.D||(a.D=new ja);return a.D}function v(a){return a&&a.D};var w=window.ShadyDOM||{};w.Z=!(!Element.prototype.attachShadow||!Node.prototype.getRootNode);var ka=Object.getOwnPropertyDescriptor(Node.prototype,"firstChild");w.g=!!(ka&&ka.configurable&&ka.get);w.L=w.force||!w.Z;var la=navigator.userAgent.match("Trident"),ma=navigator.userAgent.match("Edge");void 0===w.O&&(w.O=w.g&&(la||ma));function x(a){return(a=v(a))&&void 0!==a.firstChild}function y(a){return"ShadyRoot"===a.U}function z(a){a=a.getRootNode();if(y(a))return a}
...
Ya=Element.prototype.querySelector,Za=DocumentFragment.prototype.querySelector,$a=Document.prototype.querySelector,ab=Element.prototype.querySelectorAll,bb=DocumentFragment.prototype.querySelectorAll,cb=Document.prototype.querySelectorAll;N.appendChild=Element.prototype.appendChild;N.insertBefore=Ka;N.replaceChild=La;N.removeChild=Ma;N.setAttribute=Na;N.removeAttribute=Oa;N.cloneNode=Pa;N.importNode=Qa;N.addEventListener=Ra;N.removeEventListener=Sa;N.$=Ta;N.aa=Ua;N.dispatchEvent=Va;N.contains=Wa;
N.getElementById=Xa;N.ga=Ya;N.ja=Za;N.ea=$a;N.querySelector=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return Ya.call(this,a);case Node.DOCUMENT_NODE:return $a.call(this,a);default:return Za.call(this,a)}};N.ha=ab;N.ka=bb;N.fa=cb;N.querySelectorAll=function(a){switch(this.nodeType){case Node.ELEMENT_NODE:return ab.call(this,a);case Node.DOCUMENT_NODE:return cb.call(this,a);default:return bb.call(this,a)}};function db(a){for(;a.firstChild;)a.removeChild(a.firstChild)}
...
M.children(this)},configurable:!0},innerHTML:{get:function(){return x(this)?Ga("template"===this.localName?this.content:this):M.innerHTML(this)},set:function(a){var b="template"===this.localName?this.content:this;db(b);var c=this.localName;c&&"template"!==c||(c="div");c=this.namespaceURI&&this.namespaceURI!==fb.namespaceURI?fb.createElementNS(this.namespaceURI,c):fb.createElement(c);for(eb?H.M.innerHTML.set.call(c,a):c.innerHTML=a;c.firstChild;)b.appendChild(c.firstChild)},configurable:!0}},mb={shadowRoot:{get:function(){var a=
v(this);return a&&a.N||null},configurable:!0}},nb={activeElement:{get:function(){var a=ib&&ib.get?ib.get.call(document):w.g?void 0:document.activeElement;if(a&&a.nodeType){var b=!!y(this);if(this===document||b&&this.host!==a&&N.contains.call(this.host,a)){for(b=z(a);b&&b!==this;)a=b.host,b=z(a);a=this===document?b?null:a:b===this?a:null}else a=null}else a=null;return a},set:function(){},configurable:!0}};
...
configurable:!0})})}var pb=w.g?function(){}:function(a){var b=u(a);b.I||(b.I=!0,O(a,jb,!0),O(a,kb,!0))},qb=w.g?function(){}:function(a){u(a).R||(O(a,lb,!0),O(a,mb,!0))};var rb=M.childNodes;function sb(a,b,c){pb(a);c=c||null;var d=u(a),e=u(b),f=c?u(c):null;d.previousSibling=c?f.previousSibling:b.lastChild;if(f=v(d.previousSibling))f.nextSibling=a;if(f=v(d.nextSibling=c))f.previousSibling=a;d.parentNode=b;c?c===e.firstChild&&(e.firstChild=a):(e.lastChild=a,e.firstChild||(e.firstChild=a));e.childNodes=null}
function tb(a){var b=u(a);if(void 0===b.firstChild){b.childNodes=null;var c=rb(a);b.firstChild=c[0]||null;b.lastChild=c[c.length-1]||null;qb(a);for(b=0;b<c.length;b++){var d=c[b],e=u(d);e.parentNode=a;e.nextSibling=c[b+1]||null;e.previousSibling=c[b-1]||null;pb(d)}}};var ub=M.parentNode,vb=M.childNodes,wb={},S=w.Y&&"loading"===document.readyState,T;function xb(a){var b=[];do b.unshift(a);while(a=a.parentNode);return b}function R(a,b,c){if(a!==wb)throw new TypeError("Illegal constructor");this.U="ShadyRoot";this.host=b;this.X=c&&c.mode;tb(b);a=u(b);a.root=this;a.N="closed"!==this.X?this:null;a=u(this);a.firstChild=a.lastChild=a.parentNode=a.nextSibling=a.previousSibling=null;a.childNodes=[];this.K=this.u=!1;this.c=this.b=this.a=null;U(this)}
...
function zb(a){if(a.c&&a.c.length){for(var b=a.c,c,d=0;d<b.length;d++){var e=b[d];tb(e);tb(e.parentNode);var f=Eb(e);a.b[f]?(c=c||{},c[f]=!0,a.b[f].push(e)):a.b[f]=[e];a.a.push(e)}if(c)for(var g in c)a.b[g]=Fb(a.b[g]);a.c=[]}}function Eb(a){var b=a.name||a.getAttribute("name")||"__catchall";return a.S=b}function Fb(a){return a.sort(function(a,c){a=xb(a);for(var b=xb(c),e=0;e<a.length;e++){c=a[e];var f=b[e];if(c!==f)return a=Array.from(c.parentNode.childNodes),a.indexOf(c)-a.indexOf(f)}})}
function Bb(a){zb(a);return!(!a.a||!a.a.length)}
if(window.customElements){var V=new Map;T=function(){var a=Array.from(V);V.clear();a=r(a);for(var b=a.next();!b.done;b=a.next()){b=r(b.value);var c=b.next().value;b.next().value?c.connectedCallback():c.disconnectedCallback()}};w.Y&&"loading"===document.readyState&&document.addEventListener("readystatechange",function(){S=!1;T()},{once:!0});var Gb=function(a){var b=a.prototype.connectedCallback,c=a.prototype.disconnectedCallback,d=0,e="__isConnected"+d++;if(b||c)a.prototype.connectedCallback=function(){S?
V.set(this,!0):this[e]||(this[e]=!0,b&&b.call(this))},a.prototype.disconnectedCallback=function(){S?this.isConnected||V.set(this,!1):this[e]&&(this[e]=!1,c&&c.call(this))};return a},Hb=window.customElements.define;window.customElements.define=function(a,b){return Hb.call(window.customElements,a,Gb(b))}};var Ib=M.parentNode;
...
function Pb(a,b){if("slot"===b)a=a.parentNode,Lb(a)&&U(v(a).root);else if("slot"===a.localName&&"name"===b&&(b=z(a))){if(b.a){var c=a.S,d=Eb(a);if(d!==c){c=b.b[c];var e=c.indexOf(a);0<=e&&c.splice(e,1);c=b.b[d]||(b.b[d]=[]);c.push(a);1<c.length&&(b.b[d]=Fb(c))}}U(b)}}function Nb(a,b,c){if(a=(a=v(a))&&a.i)b&&a.addedNodes.push(b),c&&a.removedNodes.push(c),Qb(a)}
...
function Zb(a,b){var c=u(a);c.i||(c.i=new Xb);c.i.w.add(b);var d=c.i;return{T:b,W:d,V:a,takeRecords:function(){return d.takeRecords()}}}function $b(a){var b=a&&a.W;b&&(b.w.delete(a.T),b.w.size||(u(a.V).i=null))}
...
var gc={get composed(){void 0===this.m&&(bc?this.m=bc(this):!1!==this.isTrusted&&(this.m=cc[this.type]));return this.m||!1},composedPath:function(){this.H||(this.H=ec(this.__target,this.composed));return this.H},get target(){return fc(this.currentTarget,this.composedPath())},get relatedTarget(){if(!this.C)return null;this.J||(this.J=ec(this.C,!0));return fc(this.currentTarget,this.J)},stopPropagation:function(){Event.prototype.stopPropagation.call(this);this.B=!0},stopImmediatePropagation:function(){Event.prototype.stopImmediatePropagation.call(this);
...
function nc(a,b,c){if(b){var d=typeof b;if("function"===d||"object"===d)if("object"!==d||b.handleEvent&&"function"===typeof b.handleEvent){var e=this instanceof Window?N.$:N.addEventListener;if(dc[a])return e.call(this,a,b,c);if(c&&"object"===typeof c){var f=!!c.capture;var g=!!c.once;var h=!!c.passive}else f=!!c,h=g=!1;var k=c&&c.F||this,l=b[W];if(l){if(-1<mc(l,k,a,f,g,h))return}else b[W]=[];l=function(e){g&&this.removeEventListener(a,b,c);e.__target||oc(e);if(k!==this){var f=Object.getOwnPropertyDescriptor(e,
...
f),f=null):delete e.currentTarget);return h}};b[W].push({node:k,type:a,capture:f,once:g,passive:h,ba:l});ic[a]?(this.__handlers=this.__handlers||{},this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]},this.__handlers[a][f?"capture":"bubble"].push(l)):e.call(this,a,l,c)}}}
function pc(a,b,c){if(b){var d=this instanceof Window?N.aa:N.removeEventListener;if(dc[a])return d.call(this,a,b,c);if(c&&"object"===typeof c){var e=!!c.capture;var f=!!c.once;var g=!!c.passive}else e=!!c,g=f=!1;var h=c&&c.F||this,k=void 0;var l=null;try{l=b[W]}catch(n){}l&&(f=mc(l,h,a,e,f,g),-1<f&&(k=l.splice(f,1)[0].ba,l.length||(b[W]=void 0)));d.call(this,a,k||b,c);k&&ic[a]&&this.__handlers&&this.__handlers[a]&&(a=this.__handlers[a][e?"capture":"bubble"],k=a.indexOf(k),-1<k&&a.splice(k,1))}}
function qc(){for(var a in ic)window.addEventListener(a,function(a){a.__target||(oc(a),lc(a))},!0)}function oc(a){a.__target=a.target;a.C=a.relatedTarget;if(w.g){var b=Object.getPrototypeOf(a);if(!b.hasOwnProperty("__patchProto")){var c=Object.create(b);c.ca=b;oa(c,gc);b.__patchProto=c}a.__proto__=b.__patchProto}else oa(a,gc)}var rc=hc(window.Event),sc=hc(window.CustomEvent),tc=hc(window.MouseEvent);
...
function Y(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],f=Object.getOwnPropertyDescriptor(b,e);f.value?a[e]=f.value:Object.defineProperty(a,e,f)}};if(w.L){window.ShadyDOM={inUse:w.L,patch:function(a){qb(a);pb(a);return a},isShadyRoot:y,enqueue:za,flush:C,settings:w,filterMutations:ac,observeChildren:Zb,unobserveChildren:$b,nativeMethods:N,nativeTree:M,deferNativeCustomElementsConnection:!1};uc();var Ic=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Y(R.prototype,Hc);Y(window.Node.prototype,xc);Y(window.Window.prototype,wc);Y(window.Text.prototype,yc);Y(window.DocumentFragment.prototype,zc);Y(window.Element.prototype,
