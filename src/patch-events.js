  ...
  get composed() {
    if (this.__composed === undefined) {
      ...
      if (composedGetter) {
        ...
        const brokenComposed = ['focusin', 'focusout'];
        const nativeComposed = composedGetter(this);
        this.__composed = brokenComposed.indexOf(this.type) === -1 ? nativeComposed : alwaysComposed[this.type];
