  ...
  (function () {
    var handler = function handler(mxns) {
      mxns.forEach(function (mxn) {
        mxn.addedNodes.forEach(function (n) {
...
var ShadyCSS = {
  ...
  setElementClass: function setElementClass(element, selector) {
    ...
    // add user selector
    (_element$classList = element.classList).add.apply(_element$classList, toConsumableArray(selector.split(' ')));
    // scope by shadyRoot
