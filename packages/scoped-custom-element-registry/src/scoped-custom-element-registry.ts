...
const polyfillWindow = (globalThis as unknown) as PolyfillWindow;
...
if (typeof window === 'undefined') {
  console.warn(
    'The Scoped Custom Element Registry polyfill was imported in a non-browser environment. The polyfill will not be applied.'
  );
} else {
