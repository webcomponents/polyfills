...
function qa(a,c,b,d,e){d&&J(d,function(b,c){c&&a.a.get(c)&&(e="@apply "+c+";")});if(!e)return c;var f=N(a,e),h=c.slice(0,c.indexOf("--")),g=f=O(a,f),k=a.a.get(b),n=k&&k.h;n?g=Object.assign(Object.create(n),f):a.a.set(b,g);var W=[],w,x,X=!1;for(w in g)x=f[w],void 0===x&&(x="initial"),!n||w in n||(X=!0),W.push(""+b+"_-_"+w+": "+x);X&&ra(a,k);k&&(k.h=g);d&&(h=c+";"+h);return""+h+W.join("; ")+";"}M.prototype.detectMixin=M.prototype.o;M.prototype.transformStyle=M.prototype.j;
M.prototype.transformCustomStyle=M.prototype.f;M.prototype.transformRules=M.prototype.l;M.prototype.transformRule=M.prototype.g;M.prototype.transformTemplate=M.prototype.m;M.prototype._separator="_-_";Object.defineProperty(M.prototype,"invalidCallback",{get:function(){return L},set:function(a){L=a}});var P=null,Q=window.HTMLImports&&window.HTMLImports.whenReady||null,R;function sa(a){Q?Q(a):(P||(P=new Promise(function(a){R=a}),"complete"===document.readyState?R():document.addEventListener("readystatechange",function(){"complete"===document.readyState&&R()})),P.then(function(){a&&a()}))};var S=new M;function T(){var a=this;this.a=null;this.b=!1;sa(function(){U(a)});S.invalidCallback=ja}function U(a){a.b||(a.a=window.ShadyCSS.CustomStyleInterface,a.a&&(a.a.transformCallback=function(a){S.f(a)},a.a.validateCallback=function(){requestAnimationFrame(function(){a.a.enqueued&&V(a)})}),a.b=!0)}T.prototype.prepareTemplate=function(a,c){U(this);l[c]=a;c=S.m(a,c);a.b=c};
function V(a){U(a);if(a.a){a.a.findStyles();for(var c=a.a.customStyles,b=0;b<c.length;b++){var d=a.a.getStyleForCustomStyle(c[b]);d&&S.f(d)}a.a.enqueued=!1}}T.prototype.styleSubtree=function(a,c){U(this);if(c)for(var b in c)null===b?a.style.removeProperty(b):a.style.setProperty(b,c[b]);if(a.shadowRoot)for(this.styleElement(a),c=a.shadowRoot.children||a.shadowRoot.childNodes,b=0;b<c.length;b++)this.styleSubtree(c[b]);a=a.children||a.childNodes;for(c=0;c<a.length;c++)this.styleSubtree(a[c])};
T.prototype.styleElement=function(a){U(this);var c=a.is||a.getAttribute&&a.getAttribute("is")||a.localName,b=l[c];b&&b._applyShimInvalid&&(b.a||(this.prepareTemplate(b,c),ka(b)),a=a.shadowRoot)&&(a=a.querySelector("style"))&&(a.__cssRules=b.b,a.textContent=G(b.b))};T.prototype.styleDocument=function(a){U(this);this.styleSubtree(document.documentElement,a)};
